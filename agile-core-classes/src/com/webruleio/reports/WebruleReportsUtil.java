...
import com.agilecrm.db.GoogleSqlConnectionFetcher;
...
public class WebruleReportsUtil
{
 ...
 /*   public static LinkedHashMap<String, Integer> getDefaultCountTable(String[] variable)
     ...
     * @return LinkedHashMap
     */
 /*   public static LinkedHashMap<String, LinkedHashMap<String, Integer>> getWebruleStatsData(String startDate, String endDate, String type, String timeZone,
	    JSONArray sqlData)
    {
	// Types of bars in a bar graph
