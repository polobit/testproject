...
public class MandrillWebhookUtil
{
	...
	try
	{
		...
		// If exists return
		if (webhook.has(URL) && (webhook.getString(URL).equals(AGILE_MANDRILL_WEBHOOK_URL) || webhook.getString(URL).equals("https://agilecrmbeta.appspot.com/backend/mandrillwebhook")))
		    return webhook;
	    }
