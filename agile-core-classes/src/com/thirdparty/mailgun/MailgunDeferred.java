...
public class MailgunDeferred implements DeferredTask
{
    ...
    /**
     * Constructs a new {@link MailgunDeferred}
     * 
     * @param subaccount
     *            - domain name
     * @param fromEmail
     ...
     *            - text content
     */
     public MailgunDeferred(String subaccount, String fromEmail, String fromName, String to, String cc, String bcc,
    ...
    public void run()
    {
	System.out.println("MailgunDeferredTask empty run");
    }
}
