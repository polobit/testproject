...
public class MailgunNew
{
    ...
    public static String sendMail(String mailgunApikey, String mailgunDomainName, String fromEmail, String fromName, String to, String cc, String bcc,
    	    ...
    	    List<BlobKey> blobKeys, String... attachments)
        {
    	  ...
    	  if(StringUtils.isBlank(mailgunApikey)|| StringUtils.isBlank(mailgunDomainName))  
    	  {
    		  System.out.println("Mailgun Domain name or API Key should not be null or empty");
    		  return null;
    	  }
    	  ...
    	  try
    	    {
    		    ...
    		    if (documentIds != null && documentIds.size() > 0)
    		     ...
    		     {
    		    	 sendBlobAsMailAttachment(fromEmail, fromName, to, cc, bcc, subject, replyTo, html, text, metadata, blobKeys.get(0), mailgunApikey, mailgunDomainName);
    		     }
    		     else
    		     {
    		    	 FormDataMultiPart mailgunMessage=getMailgunMessage(fromEmail, fromName, to, cc, bcc, subject, replyTo, html, text, metadata);
    		    	 ...
    		    	 String response= sendMailWithAttachment(mailgunMessage, mailgunApikey, mailgunDomainName).toString();
    ...
    public static String sendMail(String fromEmail, String fromName, String to, String cc, String bcc,
    	    ...
    	    List<BlobKey> blobKeys, String... attachments)
        {
    	return sendMail(null, null, fromEmail, fromName, to, cc, bcc, subject, replyTo, html, text, metadata,
    ...
    {	
    	...
    	{
    		e.printStackTrace();
		    System.err.println("Exception occured while getting attachment from url");
    		return null;
    	}
    	}
    	    ...
    	    String subject, String replyTo, String html, String text, String metadata,BlobKey blobKey, String apiKey, String domainName)
    {
    	...
    	MailgunSendDeferredTask task = new MailgunSendDeferredTask(apiKey, domainName, fromEmail, fromName, to, cc, bcc, subject, replyTo, html, text, metadata, blobStream);
   	    // Add to queue
     ...
     * @param documentId
     */
    private static void sendDocumentAsMailAttachment( String fromEmail, String fromName, String to, String cc, String bcc,
    	    String subject, String replyTo, String html, String text, String metadata, long documentId, String apiKey, String domainName)
    {
    	...
    	MailgunSendDeferredTask task = new MailgunSendDeferredTask(apiKey, domainName, fromEmail, fromName, to, cc, bcc, subject, replyTo, html, text, metadata, documentStream);
    	 // Add to queue
 	    Queue queue = QueueFactory.getQueue("email-attachment-queue");
 	    queue.add(TaskOptions.Builder.withPayload(task));
