package com.thirdparty.mailgun;import java.io.InputStream;
 ...
 * to Mailgun server. It uses streams for writing/reading data, it sends data
 * in Multipart encoded format.
 * 
 * @author Prashannjeet
 * 
 */
...
public class MailgunSendDeferredTask implements DeferredTask
{
    ...
    public MailgunSendDeferredTask(String apiKey, String domainName, String fromEmail, String fromName, String to, String cc, String bcc,
    	    String subject, String replyTo, String html, String text, String metadata,IFileInputStream inputStream)
    {
    ...
    /**
     * Reads the input from url and converts it into Multipart format then sends it
     * to Mailgun server
     */
	...
	try
	 {
		...
		String fileNameWithEextention=inputStream.getFileName();
		
		StreamDataBodyPart	streamDataBodyPart = new StreamDataBodyPart("attachment", is, fileNameWithEextention);
		...
		ClientResponse cr=MailgunNew.sendMailWithAttachment(form, apiKey, domainName);
