 ...
 * 
 */
public class NotificationReportsSQLUtil
{
    /**
   ...
   /* public static JSONArray getAllEmailCampaignStats()
     ...
     * @return JSONArray.
     */
    public static JSONArray getNotificationStatsForGraph(String campaignId, String startDate, String endDate,
	...
	String query = "SELECT log_type,DATE_FORMAT(" + GoogleSQLUtil.addConvertTZ(timeZoneOffset) + ","+ GoogleSQLUtil.getDateFormatBasedOnType(type)+") AS log_date,"+
		...
		"FROM campaign_logs "+
                "WHERE DOMAIN="+GoogleSQLUtil.encodeSQLColumnValue(domain)+" AND campaign_id="+GoogleSQLUtil.encodeSQLColumnValue(campaignId)+" AND log_type in('PUSH_NOTIFICATION_CLICKED','PUSH_NOTIFICATION_SENT','PUSH_NOTIFICATION_SHOWN','PUSH_NOTIFICATION_SKIPPED') "+
    ...
    public static JSONArray getNotificationStatsForTable(String campaignId, String startDate, String endDate,
	    String timeZone, String type)
    {
	String domain = NamespaceManager.get();
