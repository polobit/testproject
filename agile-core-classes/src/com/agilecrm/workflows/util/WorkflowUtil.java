...
public class WorkflowUtil
{
    ...
    /**
     * Returns campaignName with respect to campaign-id and domain
     * 
     * @param campaignId
     *            - Campaign Id.
     * @return String
     */
    public static String getCampaignName(String campaignId, String domain)
    {
	if (campaignId == null || StringUtils.isEmpty(domain))
	    return null;
