...
public class SearchRule implements Serializable
{
	...
	ACTIVE, DONE, REMOVED, UNSUBSCRIBED, HARD_BOUNCE, SOFT_BOUNCE, SPAM_REPORTED, NOT_ADDED;
	
	public static EnumSet<RuleCondition> campaignConditions = EnumSet.of(ACTIVE, DONE, REMOVED, UNSUBSCRIBED, HARD_BOUNCE, SOFT_BOUNCE, SPAM_REPORTED, NOT_ADDED);
