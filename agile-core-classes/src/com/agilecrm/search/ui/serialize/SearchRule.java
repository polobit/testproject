...
public class SearchRule implements Serializable
{
	...
	public enum RuleCondition
	{
		...
		ACTIVE, DONE, REMOVED, UNSUBSCRIBED, HARDBOUNCED, SOFTBOUNCED, SPAM, NOT_ADDED, TICKET_STATUS_IS, TICKET_STATUS_IS_NOT, TICKET_TYPE_IS, TICKET_TYPE_IS_NOT, TICKET_PRIORITY_IS, TICKET_PRIORITY_IS_NOT,TICKET_SOURCE_IS, TICKET_SOURCE_IS_NOT, STARTS_WITH, ENDS_WITH;
