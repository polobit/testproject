...
public class SearchRule implements Serializable
{
	...
	{
		EQUALS, NOTEQUALS, ON, AFTER, BEFORE, ON_AFTER, ON_BEFORE, BETWEEN_NUMBER, BETWEEN, LAST, NEXT, MATCHES, IS_GREATER_THAN, IS_LESS_THAN, FIRST_TIME, REPEAT, NOT_CONTAINS, ONCE_PER_SESSION, ONLY_ONCE, EVERYTIME,
		...
		ACTIVE, DONE, REMOVED, UNSUBSCRIBED, HARDBOUNCED, SOFTBOUNCED, SPAM, NOT_ADDED, BY_MONTH_ONLY, IS_AFTER_IN_DAYS, IS_BEFORE_IN_DAYS,  TICKET_STATUS_IS, TICKET_STATUS_IS_NOT, TICKET_TYPE_IS, TICKET_TYPE_IS_NOT, TICKET_PRIORITY_IS, TICKET_PRIORITY_IS_NOT,TICKET_SOURCE_IS,TICKET_SOURCE_IS_NOT,STARTS_WITH,ENDS_WITH,LAST_UPDATED_BY_AGENT,LAST_UPDATED_BY_REQUESTER,TICKET_LABEL_IS,TICKET_LABEL_IS_NOT,TICKET_IS,TICKET_IS_NOT;
		...
		public static EnumSet<RuleCondition> partialDateConditions = EnumSet.of(BY_MONTH_ONLY, IS_AFTER_IN_DAYS, IS_BEFORE_IN_DAYS);
