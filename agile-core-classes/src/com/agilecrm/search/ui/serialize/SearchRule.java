...
public class SearchRule implements Serializable
{
	...
	ACTIVE, DONE, REMOVED, UNSUBSCRIBED, HARDBOUNCED, SOFTBOUNCED, SPAM, NOT_ADDED;
	
	public static EnumSet<RuleCondition> campaignConditions = EnumSet.of(ACTIVE, DONE, REMOVED, UNSUBSCRIBED, HARDBOUNCED, SOFTBOUNCED, SPAM, NOT_ADDED);
