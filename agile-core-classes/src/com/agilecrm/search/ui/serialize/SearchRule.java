...
public class SearchRule implements Serializable
{
	...
	IS, IS_NOT, IS_EMPTY, KNOWN, UNKNOWN, IS_NOT_EMPTY, CONTAINS, ONCE_EVERY, MAX_OF, COUNTRY_IS, COUNTRY_IS_NOT, UA_IS, UA_IS_NOT, UA_CONTAINS, UA_NOT_CONTAINS,
	
	ACTIVE, DONE, REMOVED, UNSUBSCRIBED, HARD_BOUNCED, SOFT_BOUNCED, SPAM_REPORTED, NOT_ADDED;
	
	public static EnumSet<RuleCondition> campaignConditions = EnumSet.of(ACTIVE, DONE, REMOVED, UNSUBSCRIBED, HARD_BOUNCED, SOFT_BOUNCED, SPAM_REPORTED, NOT_ADDED);
