...
public class SearchRule implements Serializable
{
	...
	ACTIVE, DONE, REMOVED, UNSUBSCRIBED, BOUNCED, SPAM_REPORTED, NOT_ADDED;
	
	public static EnumSet<RuleCondition> campaignConditions = EnumSet.of(ACTIVE, DONE, REMOVED, UNSUBSCRIBED, BOUNCED, SPAM_REPORTED, NOT_ADDED);
