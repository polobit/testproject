...
public class OpportunityDocument extends com.agilecrm.search.document.Document implements BuilderInterface
{
    ...
    public Builder buildOpportunityDoc(Opportunity opportunity)
    {
		...
		try {
			...
			if(opportunity.won_date == null || (opportunity.won_date != null && opportunity.won_date.equals(null)))
			{
			...
			// TODO Auto-generated catch block
			e.printStackTrace();
			System.out.println("Exception in opportunity doc.java "+e.getMessage());
		}
		return doc;
    }
