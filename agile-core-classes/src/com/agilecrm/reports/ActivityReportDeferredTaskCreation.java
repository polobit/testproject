...
public class ActivityReportDeferredTaskCreation
{
    ...
    {
		System.out.println("Time in create create Activity report DeferredTask ============ " + time);
		// Start a task queue for each domain
		SendActivityReportDeferredTask sendreport_deferred_task = new SendActivityReportDeferredTask(domain, time,reportid, timezone);
