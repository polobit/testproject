...
public class DocumentTemplatesPrefsAPI
{
	...
	@GET
	@Produces({ MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON })
	public DocumentTemplates getEmailTemplate(@PathParam("template-id") Long id)
	{
	...
	public DocumentTemplates createEmailTemplate(DocumentTemplates document)
	{
		document.save();
		return document;
	}
	 ...
	 * 
	 * @param document
	 *            - DcoumentTemplates object to be updated.
	 * @return DocumentTemplates.
	 */
	@PUT
	@Consumes({ MediaType.APPLICATION_JSON, MediaType.APPLICATION_XML })
