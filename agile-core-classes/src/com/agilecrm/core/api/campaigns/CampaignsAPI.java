...
public class CampaignsAPI
{
	...
	public List<CampaignLogWrapper> getContactLogs(@PathParam("contact-id") String contactId,@QueryParam("cursor") String offset,
	...
	@GET
	@Produces({ MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON })
	public List<LogWrapper> getCampaignLogs(@PathParam("campaign-id") String campaignId, @QueryParam("log-type") String logType,@QueryParam("cursor") String offset,
		    @QueryParam("page_size") String pageSize)
	{
