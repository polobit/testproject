...
public class BulkActionUtil
{
	...
	taskOptions = TaskOptions.Builder.withUrl(uri).param("filter", data[0]).param("tracker", bulk_action_tracker)
     ...
     * @return
     */
    public static List<Contact> getFilterCompanies(String criteria, String cursor, Long domainUserId)
    {
	if (criteria.isEmpty())
	    return new ArrayList<Contact>();
