...
public enum UserAccessScopes
{
	...
	//In previous versions MANAGE_CALENDAR is used for manage events permission, 
	//now manage is split into create(CREATE_CALENDAR), update(UPDATE_CALENDAR) and delete(DELETE_CALENDAR), so we are removing this
	defaultScopes.remove(UserAccessScopes.MANAGE_CALENDAR);
