...
public class Activity extends Cursor
{
    ...
    {
	CONTACT, DEAL, TASK, EVENT, CAMPAIGN, DOCUMENT, TICKET,USER, LEAD
    };
	...
	DOCUMENT_REMOVE, CAMPAIGN, BULK_ACTION, BULK_DELETE, EVENT_RELATED_CONTACTS, TASK_RELATED_CONTACTS, DEAL_RELATED_CONTACTS, BULK_EMAIL_SENT, DEAL_LOST, TAG_ADD, TAG_REMOVE, EMAIL_SENT, EVENT_ADD, DEAL_CHANGE, DEAL_ADD, DEAL_EDIT, DEAL_DELETE, DEAL_OWNER_CHANGE, DEAL_MILESTONE_CHANGE, DEAL_CLOSE,DEAL_TAG_CHANGE,DEAL_TAG_ADD,DEAL_TAG_DELETE, DOCUMENT_ADD, NOTE_ADD, CALL, CONTACT_OWNER_CHANGE,

	CONTACT_CREATE, COMPANY_CREATE,CONTACT_DELETE, COMPANY_DELETE, DEAL_ARCHIVE, DEAL_RESTORE, CONTACT_IMPORT, CONTACT_EXPORT, COMPANY_IMPORT, COMPANY_EXPORT, DEAL_IMPORT, DEAL_EXPORT, CAMPAIGN_CREATE, CAMPAIGN_EDIT, CAMPAIGN_DELETE, MERGE_CONTACT, MERGE_COMPANY,
	...
	DEAL_TASK_ADDED, DEAL_TASK_UPDATED, DEAL_TASK_DELETED, LEAD_EXPORT, LEAD_CREATE, LEAD_DELETE, LEAD_IMPORT, LEAD_TAG_ADD, LEAD_TAG_REMOVE, CHANGE_LEAD_STATUS 
    };
