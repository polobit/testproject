...
public class Activity extends Cursor
{
    ...
    {
	CONTACT, DEAL, TASK, EVENT, CAMPAIGN, DOCUMENT, TICKET,USER,ADMINPANEL, LEAD,SMS
    };
	...
	User_Email_Change,User_Name_Change,User_Password_Change,User_Permissions_Change,User_Created,User_Deleted,User_Owner_Change,User_Disabled,User_Admin_Change,
	ADMIN_PANEL_SUBSCRIPTION_CANCEL,ADMIN_PANEL_ADDED_AFFILIATE_AMOUNT,ADMIN_PANEL_REFUND_AMOUNT,ADMIN_PANEL_CHANGE_PLAN,ADMIN_PANEL_DELETE_ACCOUNT,ADMIN_PANEL_RELEASE_DOMAIN,ADMIN_PANEL_DELETED_USER,ADMIN_PANEL_SEARCHED_DOMAIN,
	ADMIN_PANEL_LOGIN_INTO_DOMAIN,ADMIN_PANEL_PERMISSIONS_CHANGED,

	DOCUMENT_REMOVE, CAMPAIGN, BULK_ACTION, BULK_DELETE, EVENT_RELATED_CONTACTS, TASK_RELATED_CONTACTS, DEAL_RELATED_CONTACTS, BULK_EMAIL_SENT, DEAL_LOST, TAG_ADD, TAG_REMOVE, EMAIL_SENT, EVENT_ADD, DEAL_CHANGE, DEAL_ADD, DEAL_EDIT, DEAL_DELETE, DEAL_OWNER_CHANGE, DEAL_MILESTONE_CHANGE, DEAL_CLOSE,DEAL_TAG_CHANGE,DEAL_TAG_ADD,DEAL_TAG_DELETE, DOCUMENT_ADD, NOTE_ADD,NOTE_EDIT,NOTE_DELETE, CALL, CONTACT_OWNER_CHANGE,
	...
	DEAL_TASK_ADDED, DEAL_TASK_UPDATED, DEAL_TASK_DELETED, SEND_EMAIL_BULK, LEAD_EXPORT, LEAD_CREATE, LEAD_DELETE, LEAD_IMPORT, LEAD_TAG_ADD, LEAD_TAG_REMOVE, CHANGE_LEAD_STATUS,
	SMS_FROM_NUMBER,SMS_TO_NUMBER,SMS_MESSAGE,SMS_SMS_CLICK_TRACKING_ID,
    };
