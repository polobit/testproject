...
public class Dameru implements DistanceCalculator
{
     ...
     */
    public Dameru(String inputString, String compareString)
    {
	/**
    ...
    public Dameru(String inputString, List<String> compareList)
    {
	this.inputString = inputString;
