...
public class SendMail {
	...
	public static void sendMail(String to, String subject, String template,
			Object object, String from, String fromName, String... args) {
		try {
			...
			// Send Email
			Mandrill.sendMail(false, from, fromName, to, null, null, subject,
					from, emailHTML, emailBody, null, null, null, args);
