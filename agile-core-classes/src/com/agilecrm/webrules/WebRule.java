...
class WebRuleAction
{
    ...
    public enum Action
    {
	POPUP, ASSIGN_CAMPAIGN, UNSUBSCRIBE_CAMPAIGN, ADD_TAG, REMOVE_TAG, ADD_SCORE, SUBTRACT_SCORE, MODAL_POPUP, CORNER_NOTY, NOTY, JAVA_SCRIPT, RUN_JAVASCRIPT, FORM,CALL_POPUP, SITE_BAR, PUSH_NOTIFICATION, REQUEST_PUSH_POPUP;
    }
