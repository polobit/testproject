...
public class ExceptionUtil {
	public static String EMAILS_PURCHASE_BLOCKED= "Sorry, it seems that you already have a pending request with us. Please contact our support to proceed further.";
