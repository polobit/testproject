...
public class Log
{
	...
	public enum LogType
	{
		EMAIL_QUEUED, EMAIL_SENT, EMAIL_OPENED, EMAIL_CLICKED, EMAIL_REPLIED, EMAIL_HARD_BOUNCED, EMAIL_SPAM, EMAIL_SOFT_BOUNCED, WAIT, CLICKED, OPENED, AB, URL_VISITED, TWEET, ADD_NOTE, TAGS, CHECK_TAGS, CONDITION, JSONIO, SCORE, SET_OWNER, ADD_TASK, ADD_DEAL, ADD_CASE, TRANSFER, GENDER, EMAIL_NOT_REPLIED, CHANGED_DEAL_MILESTONE, EMAIL_SLEEP, EMAIL_SENDING_FAILED, EMAIL_SENDING_SKIPPED, UNSUBSCRIBED, SET_PROPERTY, CAMPAIGN_STOPPED, WAIT_TILL, SMS_SENT, SMS_FAILED, SMS_LINK_CLICKED, TWEET_LINK_CLICKED, REMOVE, UNSUBSCRIBE, CLOSED_TASK, ADD_EVENT, SET_PROPERTY_FAILED,  TICKET_STATUS, TICKET_ASSIGNEE_CHANGED, TICKET_EMAIL_GROUP, TICKET_EMAIL_USER, TICKET_GROUP_CHANGED, TICKET_LABELS, TICKET_PRIORITY, TICKET_TYPE, TICKET_SET_SLA
	};
