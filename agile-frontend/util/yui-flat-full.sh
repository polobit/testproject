...
cat ../WebContent/flatfull/jscore/backbone/*.js > ../WebContent/flatfull/jscore/min/js-all-min.js

cat $(find ../WebContent/flatfull/controllers ! -path ../WebContent/flatfull/controllers/app.js -name "*.js") >> ../WebContent/flatfull/jscore/min/js-all-min.js
...
cat $(find ../WebContent/flatfull/jscore ! -path ../WebContent/flatfull/jscore/backbone/\*.js ! -path  ../WebContent/flatfull/jscore/min/*.js -name "*.js") >> ../WebContent/flatfull/jscore/min/js-all-min.js

cat ../WebContent/flatfull/controllers/app.js >> ../WebContent/flatfull/jscore/min/js-all-min.js
...
java -jar yuicompressor-2.4.7.jar ../WebContent/flatfull/jscore/min/js-all-min.js --line-break 10000 --type js -o  ../WebContent/flatfull/jscore/min/js-all-min.js
