...
if [ "$2" = true ] ; then
	scp -i $EC2_PERMISSIONS -r ../WebContent/jscore/min/flatfull/ ec2-user@ec2-54-210-171-176.compute-1.amazonaws.com:~/cdn/app/$1/jscore/min/flatfull/
	...
	echo "Updated production version : $2"
else
	echo "Beta update"
