<%@page import="com.agilecrm.util.TimeZoneUtil"%>
{
    "nodes": [
        ...
        },
        {
            ...
            "xPosition": 475,
            "yPosition": 721,
            "displayname": "Did some other action?",
            "JsonValues": [
                {
                    "name": "nodename",
                    "value": "Did some other action?"
                },
                {
                    "name": "tag_value",
                    "value": "Tag for the action"
                }
            ],
            "States": [
                {
        ...
        },
        {
            ...
            "JsonValues": [
                ...
                {
                    "name": "subject",
                    "value": "{{first_name}}, Did complete your profile yet?"
                },
                {
                    "name": "replyto_email",
                    "value": ""
...
},
{
    ...
    "type": "label"
        ...
        },
        {
            ...
            "xPosition": 459,
            "yPosition": 404,
            "displayname": "Checked out settings?",
            "JsonValues": [
                {
                    "name": "nodename",
                    "value": "Checked out settings?"
                },
                {
                    "name": "url_value",
                    "value": "www.myapp.com/settings.php"
                },
                {
                    "name": "type",
                    "value": "exact_match"
        ...
        },
        {
            ...
            "JsonValues": [
                ...
                {
                    "name": "subject",
                    "value": "{{first_name}}, Please check out the settings"
                },
                {
                    "name": "replyto_email",
                    "value": ""
...
},
{
    ...
    "type": "label"
        ...
        },
        {
            ...
            "xPosition": 455,
            "yPosition": 101,
            "displayname": "Filled profile data?",
            "JsonValues": [
                {
                    "name": "nodename",
                    "value": "Filled profile data?"
                },
                {
                    "name": "if_type",
                    "value": "strlen"
