...
baseBuilderElements.push({
    ...
    hideEditIcon: true,
 	...
 	previewScale: '0.7',
 	previewHtml: '<img data-name="responsive video" data-src="//www.youtube.com/embed/sENM2wA_FTg" class="img-responsive preview-node" src="public/images/previews/responsiveEmbedPreview.png">',
 	attributes: {
 		url: {
 			text: true,
 			value: '//www.youtube.com/embed/wGp0GAd1d1s',
