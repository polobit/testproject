...
var addAgileApi = function(json, api, callback)
{
   ...
   var agileformcaptcha = {};
	...
	agiletransparentbackground.label = "Transparency <a class='info-msg-icon-link' href='#' data-toggle='tooltip' data-original-title='If set to yes, the background of your website will be applied along with selected label text color' data-placement='right' style='text-decoration: none;'><sup style='font-size: 9px;'>?</sup></a>";
	agiletransparentbackground.type = "select";
	agiletransparentbackground.value = [{value : "", selected : true, label : "no"}, {value : " agile-form-transparent", selected : false, label: "yes with white text label"}, {value : " agile-form-blck-transparent", selected : false, label: "yes with black text label"}];
