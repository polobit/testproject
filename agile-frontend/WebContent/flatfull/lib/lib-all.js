...
/*    select: function () {
    ...
    render: function (items) {
      ...
      if (this.autoSelect && !activeFound) {        
        ...
        this.$element.data('active', items.first().data('data-value'));
      }
