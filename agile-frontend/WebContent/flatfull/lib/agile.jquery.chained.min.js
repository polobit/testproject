...
(function($) {
    ...
    $.fn.chained = function(parent_selector, options) { 
        ...
        return this.each(function() {
                ...
                $(this).bind("change", function() {
                    ...
                    if(url && related_set && related_set == $(self).attr("id"))
                    {
                  	  ...
                  	  $.getJSON(url, function(json) {
                            build.call(self, json, parse_key, parse_value);
                            if(select_value)
                            	{
                    ...
                    $("option", self).each(function() {
                    	...
                    	{
                    		var array = classAttr.split(_AGILE_CUSTOM_DIVIDER_);
                    		var count = 0;
            ...
            function build(json, parse_key, parse_value) {
                /* If select already had somet
                 * hing selected, preserve it. */
                var selected_key = $(":selected", self).val();

                /* Clear the select. */
                $(self).empty(	);
                
                var element = $('<select  name="temp'+Math.random()+'"   class="dynamic-option required form-control"></select>');
