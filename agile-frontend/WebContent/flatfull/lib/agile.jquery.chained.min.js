		...
		return this.each(function()
		{
			...
			$(parent_selector).each(function()
			{
				$(this).bind("change", function()
				{
					...
					{
						$(data).datepicker({ format : 'mm/dd/yyyy', weekStart : CALENDAR_WEEK_START_DAY });
					});
			...
			function build(json, parse_key, parse_value)
			{
				...
				var element = $('<select  name="temp' + Math.random() + '"   class="dynamic-option form-control required"></select>');
