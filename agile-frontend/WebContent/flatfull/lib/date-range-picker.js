        ...
        var DRPTemplate = '<div class="daterangepicker dropdown-menu">' +
                ...
                '<div class="ranges">' +
                  '<div class="range_inputs">' +
                    '<div class="daterangepicker_start_input" style="padding-left:11px;">' +
                      '<label for="daterangepicker_start">' + this.locale.fromLabel + '</label>' +
                      '<input class="input-mini form-control" type="text" name="daterangepicker_start" value="" disabled="disabled" />' +
                    '</div>' +
                    '<div class="daterangepicker_end_input" style="padding-left: 11px">' +
                      '<label for="daterangepicker_end">' + this.locale.toLabel + '</label>' +
                      '<input class="input-mini form-control" type="text" name="daterangepicker_end" value="" disabled="disabled" />' +
                    '</div>' +
                    '<span class="m-t-sm inline-block m-l-sm"><button class="btn btn-small btn-primary applyBtn" disabled="disabled">' + this.locale.applyLabel + '</button></span>&nbsp;' +
                    '<span class="m-t-sm inline-block m-l-sm"><button class="btn btn-small btn-default clearBtn">' + this.locale.clearLabel + '</button></span>' +
                  '</div>' +
                '</div>' +
              '</div>';
