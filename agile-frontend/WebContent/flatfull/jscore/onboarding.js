$(function(){
	...
	$("body").on("click", "#track_visitors", function(e) {
		e.preventDefault();
	...
	$("body").on("click", "#sync_new_signups", function(e) {
		e.preventDefault();
		$("#setupContent").html('<p><iframe width="560" height="390" src="//www.youtube.com/embed/CWMelsl70H4" frameborder="0" allowfullscreen></iframe></p>');
	});
	$("body").on("click", "#automate_email", function(e) {
		e.preventDefault();
	...
	$("body").on("click", "#app_messages_popups", function(e) {
		e.preventDefault();
