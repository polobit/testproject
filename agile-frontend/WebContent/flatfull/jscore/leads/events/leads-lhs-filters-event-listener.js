...
var Leads_LHS_Filters_Events_View = Base_Model_View.extend({
    events: {
        ...
        'custom_blur #lhs-lead-filter-form #RHS input.filters-tags-typeahead:not(.date)' : 'onTagAdd',
        'keyup #lhs-lead-filter-form #RHS input.filters-tags-typeahead:not(.date)'  : 'onTagAdd',
        ...
        'blur #lhs-lead-filter-form #RHS input:not(.date,.filters-tags-typeahead,.typeahead_contacts)' : 'onRHSChangeWithoutDateAndTags',
        'keyup #lhs-lead-filter-form #RHS input:not(.date,.filters-tags-typeahead,.typeahead_contacts)' : 'onRHSChangeWithoutDateAndTags',
        'change #lhs-lead-filter-form #RHS input.date' : 'onFilterDateChange',
        'keyup #lhs-lead-filter-form #RHS input.date' : 'onFilterDateChange',
        'change #lhs-lead-filter-form #RHS select' : 'onRHSChange',
        'change #lhs-lead-filter-form #RHS_NEW select' : 'onRHSNEWChange',
        'blur #lhs-lead-filter-form #RHS_NEW input:not(.date)' : 'onRHSNEWNotDateChange',
        'keyup #lhs-lead-filter-form #RHS_NEW input:not(.date)' : 'onRHSNEWNotDateChange',
        'change #lhs-lead-filter-form #RHS_NEW input.date' : 'onRHSNEWDateChange',
        'keyup #lhs-lead-filter-form #RHS_NEW input.date' : 'onRHSNEWDateChange',
