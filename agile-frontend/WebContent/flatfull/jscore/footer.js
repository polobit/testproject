	...
	$("body").on('click', '#share-email', function(e){
        ...
        getTemplate("share-by-email", CURRENT_DOMAIN_USER, undefined, function(template_ui){
			...
			$("body").on('click', '#shareMail', function(e){
					...
					// Shows message 
				    $save_info = $('<img src="'+updateImageS3Path("img/1-0.gif")+'" height="18px" width="18px"></img>&nbsp;&nbsp;<span><p class="text-success" style="color:#008000; font-size:15px; display:inline-block"> <i>'+_agile_get_translated_val('admin-settings-integrations','sending-emails')+'</i></p></span>');
