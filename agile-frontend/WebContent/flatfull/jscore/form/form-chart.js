...
{
	$("#form-table-reports").html(getRandomLoadingImg());

	$.getJSON('core/api/form-analytics/form/table-reports/' + formid + getOptions(), function(data)
	{

		console.log(data);

		// Load Reports Template
		getTemplate("form-table-reports", data, undefined, function(template_ui){
			if(!template_ui)
				  return;
			$("#form-table-reports").html($(template_ui));	
		}, "#form-table-reports");
