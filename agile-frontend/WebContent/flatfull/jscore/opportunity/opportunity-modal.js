     ...
     if (value.tagsWithTime && value.tagsWithTime.length)
		{
			...
			for(i=0;i<value.tagsWithTime.length;i++){
				...
				.find(".tags")
				.append('<li class="tag btn btn-xs btn-default m-r-xs m-b-xs inline-block" data="' + data + '"><span class="m-r-xs v-middle">' + data + '</span><a class="close" id="remove_tag">&times</a></li>');
			} 
	}
