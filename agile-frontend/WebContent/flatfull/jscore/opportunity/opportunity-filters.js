...
function initializeDealsListners(el){
	
	$('#deals-right-view').off('click').on('click', '.deals-list-view', function(e) {
		e.preventDefault();
	 ...
	 */
	$('#deals-right-view').off('click').on('click', '.deals-pipelined-view', function(e) {
		e.preventDefault();
	 ...
	 * creates the pipelined view cookie
	 */
	$('#deals-right-view').off('click').on('click', '.deals-export-csv', function(e) {
		e.preventDefault();
...
$('body').on('click', '#opportunity-track-list-model-list a.pipeline', function(e) {
	...
	$('#deals-right-view').off('click').on('click', '.add-pipeline', function(e) {
	...
	$('#deals-right-view').off('click').on('click', '.pipeline-edit', function(e) {
		var id = $(this).attr('id');
	 ...
	 * creates the pipelined view cookie
	 */
	$('#deals-right-view').off('click').on('click', '.pipeline-delete', function(e) {
		e.preventDefault();
		var id = $(this).attr('id');
	 ...
	 */
	$('#deals-right-view').off('click').on('click', '.milestone-delete', function(e) {
		e.preventDefault();
	 ...
	 */
	$('#deals-right-view').off('click').on('click', '.show_milestone_field', function(e) {
    	e.preventDefault();
	 ...
	 */
	$('#deals-right-view').off('click').on('click', '.add_milestone', function(e) {
	...
	$('#deals-right-view').off('click').on('keypress', '.add_new_milestone', function(e) {
    	if(e.keyCode == 13)
    	{
    		var form = $(this).closest("form");
	...
	$('#deals-right-view').off('click').on('click', '.save-pipelines', function(e) {
    	e.preventDefault();
	...
	$('#deals-right-view').off('click').on('click', '#pipeline_validate', function(e) {
    	e.preventDefault();
...
// Show filter drop down.
	$('#content').off('click').on('click', '#show-filter-button', function(e) {
		e.preventDefault();
...
/**
	 * Shows deal popup
	 */
	$('#deals-right-view').off('click').on('click', '.deals-add', function(e)
	{
		e.preventDefault();
		show_deal();
	});
	 ...
	 */
	$('#deals-right-view').off('click').on('click', '#opportunity_validate', function(e)
	{
		e.preventDefault();
...
/**
	 * Deal list view edit
	 */
	$('#deals-right-view').off('click').on('click', '#opportunities-model-list > tr > td:not(":first-child")', function(e){
		e.preventDefault();
		$('.popover').remove();
	...
	$('#deals-right-view').off('click').on('mouseenter', '.milestones > li', function(e)
	{
		$(this).find('.deal-options').css("visibility", "visible");
	});

	$('#deals-right-view').off('click').on('mouseleave', '.milestones > li', function(e)
	{
	 ...
	 */
	$('#deals-right-view').off('click').on('click', '.deal-edit', function(e)
	{
		e.preventDefault();
	 ...
	 */
	$('#deals-right-view').off('click').on('click', '.deal-delete', function(e)
	{
		e.preventDefault();
		if (!confirm("Are you sure you want to delete?"))
			return;
	 ...
	 */
	$('#deals-right-view').off('click').on('change', '#pipeline', function(e)
	{
	...
	$('#deals-right-view').off('click').on('click', '#opportunity_archive', function(e)
	{
		e.preventDefault();
		$('#archived', $('#opportunityUpdateForm')).attr('checked', 'checked');
		$("#opportunityUpdateModal #opportunity_validate").trigger('click');
	});
	$('#deals-right-view').off('click').on('click', '#opportunity_unarchive', function(e)
	{
		e.preventDefault();
	...
	$('#deals-right-view').off('click').on('click', '#deal-quick-archive', function(e)
					{
						e.preventDefault();
	...
	$('#deals-right-view').off('click').on('click', '#deal-quick-restore', function(e)
					{
						e.preventDefault();
	 ...
	 * Milestone view deal delete
	 */
	$('#deals-right-view').off('click').on('click', '.deal-archive', function(e)
	{
		e.preventDefault();
	 ...
	 * Milestone view deal delete
	 */
	$('#deals-right-view').off('click').on('click', '.deal-restore', function(e)
	{
		e.preventDefault();
	...
	$('#deals-right-view').off('click').on('change', '#pipeline_milestone', function(e)
	{
		var temp = $(this).val();
