...
var Contacts_Events_Collection_View = Base_Collection_View.extend({
    ...
    bulkActionRevertAvailContacts : function(e){
		...
		if(company_util.isCompany()){
			...
			html = _agile_get_translated_val('companies-view','selected') + " " + resultCount + " " +_agile_get_translated_val('contact-details','companies')+ ". <a href='#'  id='select-all-available-contacts' class='c-p text-info'>" + _agile_get_translated_val('contacts','select-all')+" " + appCount + " " +_agile_get_translated_val('contact-details','companies')+"</a>";
		}else{
			...
			html = _agile_get_translated_val('companies-view','selected') + " " + resultCount + " "+_agile_get_translated_val('contact-details','contacts')+". <a href='#'  id='select-all-available-contacts' class='c-p text-info'>" +_agile_get_translated_val('contacts','select-all')+ " " + appCount + " " +_agile_get_translated_val('contact-details','contacts')+ "</a>";
		}
...
select_contacts :  function(e)
			{
				...
				if(company_util.isCompany()){
					...
					html = ' '+_agile_get_translated_val('contacts','select-all')+' ' + resultCount + ' '+_agile_get_translated_val('contact-details','companies')+'. <a hrer="#" id="select-all-revert" class="c-p text-info">'+_agile_get_translated_val('companies', 'select-choosen-only')+'</a>';
				}else{
					if(localStorage.getItem("dynamic_contact_filter") != null || localStorage.getItem("contact_filter") != null){				
						if(resultCount > limitValue){
							resultCount = limitValue + "+";
					...
					html = ' '+_agile_get_translated_val('contacts','select-all')+' ' + resultCount + ' '+_agile_get_translated_val('contact-details','contacts')+'. <a hrer="#" id="select-all-revert" class="c-p text-info">'+_agile_get_translated_val('contacts', 'select-choosen-only')+'</a>';
				}
