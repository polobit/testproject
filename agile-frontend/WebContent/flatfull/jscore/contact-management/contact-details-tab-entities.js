...
var contact_details_tab = {
		...
		load_stats : function()
		{
			...
			get_web_stats_count_for_domain(function(count){
				...
				{
					$('#stats', App_Contacts.contactDetailView.el).html('<h4 class="text-sm text-muted wrapper-sm font-normal m-none text-center"><p>You have not yet setup the Javascript API on your website.</p><p>Please <a href="#analytics-code">set it up</a> to see the contact\'s site visits here.</p></h4>');
					return;
				}
