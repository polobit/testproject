	        ...
	        contact.save(json,{
	       		success: function(data){
	       			...
	       			if ($.inArray(new_tags, old_tags) == -1) 
	       				$('#added-tags-ul').append('<li  class="tag inline-block btn btn-xs btn-primary m-r-xs" data="' + new_tags + '"><span><a class="anchor m-r-xs" href="#tags/'+ new_tags + '" >'+ new_tags + '</a><a class="close remove-tags" id="' + new_tags + '" tag="'+new_tags+'">&times</a></span></li>');
