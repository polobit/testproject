var Ticket_Reports = {
	...
	dailyTickets: function(){
		...
		showBar('/core/api/tickets/reports/daily-reports?start_time=' + start_time + '&end_time=' + end_time,
			'daily-tickets-chart', '', 'Tickets count', false);
	},

	hourlyTickets: function(){
		...
		showBar('/core/api/tickets/reports/hourly-reports?start_time=' + start_time,
			'hourly-tickets-chart', '', 'Tickets count', false);
	},
