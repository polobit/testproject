...
function append_tag_management(base_model) {
  ...
  /*  if(new_tag.value){
    	$( ".tag_heading" ).each(function() {
              if($(this).text() != new_tag.value){
	...
	var flag=true;
	var previous_alphabet;
	var alphabet_flag = true;
	 if(new_tag.value){

	 	$(".tag_heading" ).each(function(index) {
              if($(this).text() == new_tag.value.charAt(0).toUpperCase()){
                 flag = false;
               }
               if($(this).text().charCodeAt(0)>new_tag.value.charAt(0).toUpperCase().charCodeAt(0) && alphabet_flag)
               {
               	alphabet_flag = false;
               	previous_alphabet = index;
               }
	 ...
	 if(flag && !$(".tag_heading").text()){
	 	if(new_tag.value)
	  	$(".tag-list-group" ).append("<div class='row b-b p-b-md'><div class='col-md-1 tag_heading' style='font-size:16px;padding-top:20px;'>" + new_tag.value.charAt(0).toUpperCase() + "</div><div class='col-md-10'><div tag-alphabet=\"" + encodeURI(new_tag.value.charAt(0).toUpperCase()) + "\"><ul class=\"tags-management tag-cloud\" style=\"list-style:none;\"></ul></div></div></div>");
	  }
	  else if(flag && alphabet_flag){
	  	if(new_tag.value)
	  	$(".tag-list-group" ).append("<div class='row b-b p-b-md'><div class='col-md-1 tag_heading' style='font-size:16px;padding-top:20px;'>" + new_tag.value.charAt(0).toUpperCase() + "</div><div class='col-md-10'><div tag-alphabet=\"" + encodeURI(new_tag.value.charAt(0).toUpperCase()) + "\"><ul class=\"tags-management tag-cloud\" style=\"list-style:none;\"></ul></div></div></div>");
	  }
	  else if(flag && $(".tag_heading").text()){
       if(!alphabet_flag && new_tag.value )
	      $(".tag_heading" ).eq(previous_alphabet).parent().before("<div class='row b-b p-b-md'><div class='col-md-1 tag_heading' style='font-size:16px;padding-top:20px;'>" + new_tag.value.charAt(0).toUpperCase() + "</div><div class='col-md-10'><div tag-alphabet=\"" + encodeURI(new_tag.value.charAt(0).toUpperCase()) + "\"><ul class=\"tags-management tag-cloud\" style=\"list-style:none;\"></ul></div></div></div>");
	   else
	   	  if(new_tag.value)
	   	  $(".tag-list-group" ).append("<div class='row b-b p-b-md'><div class='col-md-1 tag_heading' style='font-size:16px;padding-top:20px;'>" + new_tag.value.charAt(0).toUpperCase() + "</div><div class='col-md-10'><div tag-alphabet=\"" + encodeURI(new_tag.value.charAt(0).toUpperCase()) + "\"><ul class=\"tags-management tag-cloud\" style=\"list-style:none;\"></ul></div></div></div>");
	  }
