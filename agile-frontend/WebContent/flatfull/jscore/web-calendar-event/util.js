	...
	var addList = function()
	{
		...
		for (i = 0; i <= numRow; i++)
		{
			if (k < Available_Slots.length)
				listSlot = listSlot + '<li><label class="i-checks i-checks-sm"><input class="selected-slot" type="checkbox" id="startTime_' + k + '"name="startTime_' + k + '" value="' + Available_Slots[k][0] + '" /><i></i></label><label for="' + Available_Slots[k][0] + '">' + getConvertedTimeFromEpoch(Available_Slots[k][0]) + '</label></li>';
