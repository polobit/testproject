	...
	Handlebars
			.registerHelper(
					...
					function(tags)
					{
						...
						for (var i = 0; i < keys.length; i++)
							html_temp += "<div class='row b-b p-b-md' id='"+keys[i]+"'><div class='col-md-1 p-t tag-alphabet' style='font-size:16px;padding-top:20px;'>" + keys[i] + "</div><div class='col-md-10'><div tag-alphabet=\"" + encodeURI(keys[i]) + "\"><ul class=\"tags-management tag-cloud\" style=\"list-style:none;\"></ul></div></div></div>";
	...
	Handlebars
			.registerHelper(
					...
					function(tags)
					{
						...
						for (var i = 0; i < keys.length; i++)
							html_temp += "<div class='row b-b p-b-md' id='"+keys[i]+"'><div class='col-md-1 tag-alphabet' style='font-size:16px;padding-top:20px;'>" + keys[i] + "</div><div class='col-md-10'><div tag-alphabet=\"" + encodeURI(keys[i]) + "\"><ul class=\"tags-management tag-cloud\" style=\"list-style:none;\"></ul></div></div></div>";
