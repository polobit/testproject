	...
	Handlebars
			.registerHelper(
					...
					function(frame_size, additional_style)
					{
						...
						// fetch from
						var default_return = "src='"+updateImageS3Path('img/company-default-image.png')+"' style='width:" + full_size + "px; height=" + full_size + "px;" + additional_style + "'";
						...
						for (var i = 0; i < this.properties.length; i++)
						{
							if (this.properties[i].name == "image")
							{
								...
								error_fxn = "this.src='"+updateImageS3Path('img/company-default-image.png')+"'; this.onerror=null;";
							...
							if (this.properties[i].name == "url")
							{
								...
								error_fxn = "this.src='"+updateImageS3Path("img/company-default-image.png")+"'; " + "$(this).css('width','" + frame_size + "px'); $(this).css('height','" + frame_size + "px');" + "$(this).css('padding','4px'); this.onerror=null;";
