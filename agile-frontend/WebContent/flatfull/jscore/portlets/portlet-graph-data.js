var portlet_graph_data_utility = {
	...
	dealsByMilestoneGraphData : function(base_model, selector, url){
			...
			this.fetchPortletsGraphData(url,function(data){
				if(data.status==403){
				...
				portlet_graph_utility.dealsByMilestonePieGraph(selector,milestonesList,milestoneValuesList,milestoneNumbersList);
	...
	closuresPerPersonGraphData : function(base_model, selector, url){
			...
			this.fetchPortletsGraphData(url,function(data){
				...
				portlet_graph_utility.closuresPerPersonBarGraph(selector,catges,data2,text,name);
	...
	dealsFunnelGraphData : function(base_model, selector, url){
			...
			this.fetchPortletsGraphData(url,function(data){
				...
				if(falg)
					...
					funnel_data = [];
				portlet_graph_utility.dealsFunnelGraph(selector,funnel_data);
	...
	emailsSentGrapgData : function(base_model, selector, url){
			...
			this.fetchPortletsGraphData(url,function(data){
				...
				portlet_graph_utility.emailsSentBarGraph(selector,domainUsersList,series,mailsCountList,mailsOpenedCountList,text,colors);
	...
	growthGraphData : function(base_model, selector, url){
			...
			this.fetchPortletsGraphData(url,function(data){
				...
				portlet_graph_utility.portletGrowthGraph(selector,series,base_model,categories,min_tick_interval);
	...
	dealsAssignedGraphData : function(base_model, selector, url){
			...
			this.fetchPortletsGraphData(url,function(data){
				...
				portlet_graph_utility.dealsAssignedBarGraph(selector,domainUsersList,dealsAssignedCountList);
	...
	taskReportGraphData : function(base_model, selector, url){
			...
			this.fetchPortletsGraphData(url,function(data){
				...
				portlet_graph_utility.taskReportBarGraph(selector,groupByNamesList,series,text,base_model,domainUserNamesList);
	...
	revenueGraphData : function(base_model, selector, url){
			this.fetchPortletsGraphData(url,function(data){
				...
				portlet_graph_utility.portletDealRevenueGraph(selector,series,base_model,categories);
	...
	emailsOpenedGraphData : function(base_model, selector, url){
			...
			this.fetchPortletsGraphData(url,function(data){
				...
				portlet_graph_utility.emailsOpenedPieChart(selector,series,emailsSentCount,emailsOpenedCount);
