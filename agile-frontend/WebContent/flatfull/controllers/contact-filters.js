...
function setUpContactView(cel){
	...
	{
		$('#contacts-view-options', cel).html("<a class='btn btn-default btn-sm contacts-view' data='list'><i class='fa fa-list' data-toggle='tooltip' data-placement='left' title='' data-original-title='List View' style='margin-right:3px'></i></a>");
	}
	else{
		$('#contacts-view-options', cel).html("<a class='btn btn-default btn-sm contacts-view' data='grid'><i class='fa fa-th-large' data-toggle='tooltip' data-placement='left' title='' data-original-title='Grid View'  style='margin-right:3px'></i></a>");
	}
