...
function sendMail(id,subject,body,cc,bcc,that,custom_view)
{
	var model = {};
		...
		if(!canSendEmails(1))
		{
			...
			var yes = "";
			var no = "Ok"
			var upgrade_link =  'Please <a style="color:" href="#subscribe" class="action text-info" data-dismiss="modal" subscribe="subscribe" action="deny"> upgrade </a> your email subscription.';
