...
$(function()
{
	...
	$("body").on("click", "ul#user-select li a, ul#entity_type li a",function(e)
	{
		e.preventDefault();
	...
	$("body").on("click", "ul#entity_type li a",function(e)
	{
	...
	$("body").on("click", "ul#user-select li a",function(e)
	{
