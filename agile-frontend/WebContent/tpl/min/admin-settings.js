...
<script id="admin-settings-import-stripe-contact-sync-template"
    ...
    <div>
			{{#if id}}
				...
				<a href="#sync/stripe-import" class="btn" id="setting-widget">Settings</a>
    		{{else}}
				{{#canSyncContacts}}
...
<div class="row">
	<div class='span9'>
		...
		{{#isTracksEligible}}
		{{else}}
		<div class="pull-right" style="margin-top:2px;"><i>Regular or Pro plan only</i></div>
		<div class="clearfix"></div>
		{{/isTracksEligible}}
		</div>
    			...
    			<fieldset>
					...
					<div class="controls">
						<div class="multiple-checkbox" name="newscopes">
								<label class="checkbox" >
                            	<input type="checkbox" name="temp"  value="CREATE_CONTACT" checked> 
                            		Create Contacts <br/>
									<small> Add contacts</small>
								</label>
								<label class="checkbox" >
            	            	    <input type="checkbox" name="temp"  value="IMPORT_CONTACTS" checked> 
        	                    	Import Contacts  <br/>
									<small> Import from CSV file, sync from Google Apps and other integrations </small>
    	                       </label>
								<label class="checkbox" >
                        	    	<input type="checkbox" name="temp"  value="VIEW_CONTACTS" checked> 
                            		View All Contacts  <br/>
									<small> View contacts owned by other users</small>
                           		</label>
								<label class="checkbox" >
                        		    <input type="checkbox" name="temp" value="DELETE_CONTACTS" checked> 
						...
						<div class="multiple-checkbox"  name="newscopes">
								<label class="checkbox" >
                            	<input type="checkbox" name="temp"  value="CREATE_CONTACT"> 
                            		Create Contacts <br/>
									<small> Add contacts</small>
								</label>
								<label class="checkbox" >
            	            	    <input type="checkbox" name="temp"  value="IMPORT_CONTACTS"> 
        	                    	Import Contacts  <br/>
									<small> Import from CSV file, sync from Google Apps and other integrations</small>
    	                       </label>
								<label class="checkbox" >
                        	    	<input type="checkbox" name="temp"  value="VIEW_CONTACTS"> 
                            		View All Contacts  <br/>
									<small> View contacts owned by other users </small>
                           		</label>
								<label class="checkbox" >
                        		    <input type="checkbox" name="temp" value="DELETE_CONTACTS"> 
                        	    	Update All Contacts  <br/>
									<small>  Edit and delete contacts owned by other users</small>
                    	       </label>
							</div>
					...
					<div class="control-group">
						...
						<div class="multiple-checkbox"  name="newscopes">
									<label class="checkbox" >
                            	<input type="checkbox" name="temp"  value="CREATE_CONTACT" disabled> 
                            		Create Contacts <br/>
									<small> Add contacts</small>
								</label>
								<label class="checkbox" >
            	            	    <input type="checkbox" name="temp"  value="IMPORT_CONTACTS" disabled> 
        	                    	Import Contacts  <br/>
									<small> Import from CSV file, sync from Google Apps and other integrations </small>
    	                       </label>
								<label class="checkbox" >
                        	    	<input type="checkbox" name="temp"  value="VIEW_CONTACTS" disabled> 
                            		View All Contacts  <br/>
									<small> View contacts owned by other users </small>
                           		</label>
								<label class="checkbox" >
                        		    <input type="checkbox" name="temp" value="DELETE_CONTACTS" disabled> 
                        	    	Update All Contacts  <br/>
									<small>  Edit and delete contacts owned by other users</small>
                    	       </label>
							</div>
					...
					{{#if id}}
						<label class="checkbox hide"  >
                        		    <input type="checkbox" name="scopes-temp" class="required hide" value="CONTACT" checked> 
                        	    	Contacts<br/><small>Manage contacts</small></label> 
								<label class="checkbox"  >
                        		    <input type="checkbox" name="scopes-temp" class="required" value="CALENDAR" > 
                        	    	Calendar<br/><small>Manage your tasks and events</small></label> 
								<label class="checkbox"  >
            	            	    <input type="checkbox" name="scopes-temp" class="required" value="DEALS"> 
        	                    	Deals<br/>
									<small> Track sales opportunities</small>
    	                       </label><label class="checkbox"  >
                        	    	<input type="checkbox" name="scopes-temp" class="required" value="CAMPAIGN"> 
                            		Campaigns<br/>
										<small> Automate marketing</small>
                           		</label>
						
								 </label><label class="checkbox"  >
                        	    	<input type="checkbox" name="scopes-temp" class="required" value="CASES"> 
                            		Cases<br/>
									<small>Log and address customer issues</small>
                           		</label>
 								</label><label class="checkbox"  >
                        	    	<input type="checkbox" name="scopes-temp"  class="required" value="SOCIAL" > 
                            		Social Suite<br/>
									<small> Monitor your brand on social media</small>
                           		</label>
								</label><label class="checkbox"  >
                        	    	<input type="checkbox" name="scopes-temp" class="required" value="WEBRULE" > 
                            		Web Rule<br/>
									<small> Enagage your website visitors with smart popups, or perform automatic actions </small>
                           		</label>
								</label><label class="checkbox"  >
                        	    	<input type="checkbox" name="scopes-temp" class="required" value="DOCUMENT" > 
                            		Documents<br/>
								<small> Upload and attach documents to contacts, deals or cases</small>
                           		</label>
								</label><label class="checkbox"  >
                        	    	<input type="checkbox" name="scopes-temp"  class="required" value="ACTIVITY" > 
                            		Activities<br/>
									<small> Know what other users are doing</small>
                           		</label>
								</label><label class="checkbox"  >
                        	    	<input type="checkbox" name="scopes-temp"  class="required" value="REPORT" > 
                            		Reports<br/>
						...
						{{else}}
								<label class="checkbox hide"  >
                        	    	...
                        	    	Contacts<br/><small>Manage contacts</small></label> 
								<label class="checkbox"  >
                        		    <input type="checkbox" name="scopes-temp" class="required" value="CALENDAR" checked> 
                        	    	Calendar<br/><small>Manage your tasks and events</small></label> 
								<label class="checkbox"  >
            	            	    <input type="checkbox" name="scopes-temp" class="required" value="DEALS" checked> 
        	                    	Deals<br/>
									<small> Track sales opportunities</small>
    	                       </label><label class="checkbox"  >
                        	    	<input type="checkbox" name="scopes-temp" class="required" value="CAMPAIGN" checked> 
                            		Campaigns<br/>
										<small> Automate marketing</small>
                           		</label>
						
								 </label><label class="checkbox"  >
                        	    	<input type="checkbox" name="scopes-temp" class="required" value="CASES" checked> 
                            		Cases<br/>
									<small>Log and address customer issues</small>
                           		</label>
 								</label><label class="checkbox"  >
                        	    	<input type="checkbox" name="scopes-temp"  class="required" value="SOCIAL" checked> 
                            		Social Suite<br/>
									<small> Monitor your brand on social media</small>
                           		</label>
								</label><label class="checkbox"  >
                        	    	<input type="checkbox" name="scopes-temp" class="required" value="WEBRULE" checked> 
                            		Web Rule<br/>
									<small> Enagage your website visitors with smart popups, or perform automatic actions </small>
                           		</label>
								</label><label class="checkbox"  >
                        	    	<input type="checkbox" name="scopes-temp" class="required" value="DOCUMENT" checked> 
                            		Documents<br/>
								<small> Upload and attach documents to contacts, deals or cases</small>
                           		</label>
								</label><label class="checkbox"  >
                        	    	<input type="checkbox" name="scopes-temp"  class="required" value="ACTIVITY" checked> 
                            		Activities<br/>
									<small> Know what other users are doing</small>
                           		</label>
								</label><label class="checkbox"  >
                        	    	<input type="checkbox" name="scopes-temp"  class="required" value="REPORT" checked> 
                            		Reports<br/>
									<small> Stay on top of your data</small>
                           		</label>
				...
				<div class="well" style="width:220px; height:200px;">
					...
					<div style="float:left;">
						{{#if this.length}}	
							...
							{{else}}
								{{#check_plan "FREE"}}
									<a class="btn" disabled="disabled><i class="icon-plus" style="margin-right:5px"></i>Enable</a><span style="margin-left:5px"><i>Paid accounts only</i></span>
								{{else}}
