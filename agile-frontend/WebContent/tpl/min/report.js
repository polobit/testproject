...
<div class="row">
    <div class="span12">
		...
		<div class='pull-right' style="padding:0px 8px 10px">
			...
			<div id="plan-limit-error" class="pull-right" style="display:none"></div>
    ...
    <div class="span12">
        <div class="page-header" style="padding-bottom:40px!important">          
			...
			<div class='pull-right' style="padding:0px 8px 10px">
            	...
            	<h1>Ratio Reports<small> - <span id="reports-ratio-tags"></span></small></h1><br/>
				<div id="plan-limit-error" class="pull-right" style="display:none"></div>
    </div>
        </div>
 ...
 <div class="text-left" style="/*margin: 40px auto;	width: 50%;*/ display:inline;" class="left">
			...
			{{else}}
				<div style="/*margin: 40px auto;	width: 50%;*/ display:inline;float:left;">
					<div class="btn btn-primary _upgrade" id="activity-reports-upgrade">Go</div>
				</div>
				 <div style="display:inline;float:right;display:none; max-width:135px" class="text-right activity-reports-upgrade" ><p><i>{{toSafeString message}}</i><p></div>
