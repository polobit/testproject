...
<html xmlns="http://www.w3.org/1999/xhtml">
   <head>
      ...
      <link href="misc/formbuilder/custom.css?v=3-2" rel="stylesheet">
      <!--[if lt IE 9]>
   ...
   <body>
      ...
      <!-- /container back -->
      <script data-main="misc/formbuilder/main-built-v2-8.js" src="misc/formbuilder/assets/lib/require.js?v=3" ></script>
   </body>
</html>