...
function getMergeFieldsWithOptGroups(uiFieldDefinition, selectEventHandler) {
	...
	var selectoption;
	    ...
	    if(uiFieldDefinition.style)
	    	...
	    	selectoption= "<select style='position:relative;float:right;cursor:pointer;width: 150px;margin-right: -5px' onchange="+ selectEventHandler + "(this,'"+ uiFieldDefinition.target_type +"') +  name='" + uiFieldDefinition.name + "' title='" + uiFieldDefinition.title + "'" + (uiFieldDefinition.required ? ("required =" + uiFieldDefinition.required) : "" )+"></select>";
