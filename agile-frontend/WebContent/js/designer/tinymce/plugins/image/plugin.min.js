...
tinymce.PluginManager.add('image', function(editor) {
	...
	function showDialog(imageList) {
		...
		function uploadImageToS3(){ 
			var newwindow = window.open("flatfull/upload-flatfull.jsp?id=tinymce_image_upload",'image_upload','height=310,width=500');
			if (!window.focus)
				    return;
			newwindow.focus();
		...
		var generalFormItems = [
			{
				...
				autofocus: true,
				onchange: srcChange
			},{name: 'browse', text: 'Browse', label: 'Browse', value: 'Browse', type: 'button', onclick: uploadImageToS3},
			imageListCtrl
		];
