...
var SettingsRouter = Backbone.Router
		.extend({
			...
			imap : function()
			{
				...
				/**
				 * Select imap server folder, will fetch mails from these
				 * folders
				 */
			...
			gmailShare : function(id)
			{
				...
				// Gets GMAIL Prefs
				var gmailShareView = new Base_Model_View({ url : '/core/api/social-prefs/GMAIL', template : "settings-gmail-prefs-share",
					postRenderCallback : function(el)
					{
