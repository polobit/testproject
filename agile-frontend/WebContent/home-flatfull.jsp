...
<link rel="stylesheet" type="text/css" href="css/min/lib-all-new.css?_=<%=_AGILE_VERSION%>"></link>
<!-- <link rel="stylesheet" type="text/css" href="<%=FLAT_FULL_PATH%>css/agile-app-framework.css">  -->
<link rel="stylesheet" type="text/css" href="css/min/misc-all-new.css?_=<%=_AGILE_VERSION%>"></link>
<link rel="stylesheet" type="text/css" href="css/min/core-all-new.css?_=<%=_AGILE_VERSION%>"></link>
