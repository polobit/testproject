...
head.load(LIB_PATH + 'final-lib/min/lib-all-min.js?_=' + _AGILE_VERSION, function(){
        load_globalize();
...
head.js(CLOUDFRONT_PATH + "tpl/min/precompiled/" + FLAT_FULL_PATH + "tpl-combined.js" + "?_=" + _AGILE_VERSION);
else
