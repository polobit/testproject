...
var contact_details_tab = {
		...
		load_mail : function()
		{
			...
			if(!email){
				console.log()
				$('#mail', App_Contacts.contactDetailView.el).html('<div class="alert alert-error span4" style="margin-top:30px"><a class="close" data-dismiss="alert" href="#">&times;</a>Sorry! this contact has no email to get the mails.</div>').show();
				return;	
			}	
