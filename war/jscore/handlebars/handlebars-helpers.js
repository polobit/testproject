$(function() {
	...
	Handlebars.registerHelper('deals_by_milestones', function(data) {
		...
		$.each(data, function(key, value) {
			html += "<div style='width:25%;vertical-align:top;border-right:1px solid #d5d5d5;display:inline-block;'><p style='padding: 7px 0px;text-align:center;font-size:17px;color:white;background-color:grey;'><b>" + key +"</b></p><ul class='milestones "+ key +"' milestone='"+ key +"' style='height:450px;overflow-y:auto!important;list-style:none;margin-left:0px;'>";
			for(var i in value){
