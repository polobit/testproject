function serializeForm(form_id) {
	...
	// Serialize tags
	arr = arr.concat($('#' + form_id + ' .tags').map(function() {
		var values = [];
							...
							if (tag == "select" || tag == "textarea") { // ...
								...
								if (type == "text" || type == "password"
									...
									if (el) {
										...
										// Set all values as true by default for
										...
										.each(
												...
												function(index, contact) {
													...
													$('.' + fel.attr('class'),
															form)
															.append(
																	'<li class="label label-warning" value="'
																			+ tag_id
																			+ '" style="display: inline-block; vertical-align: middle; margin-right:3px; ">'
																			+ tag_name
																			+ '<a class="icon-remove" id="remove_tag"></a></li>');
												});
							}
										...
										.each(
												...
												function(index, data) {
													...
													if (index > 0) {
														...
														$(rule_element)
																.find(
																		"i.filter-contacts-multiple-remove")
																.css("display",
																		"inline-block");
