...
/**
 * Sets dashboard. call methods to fetch contact, deals, tasks, workflows and subscription details
 * @param el
 */
...
/**
 * Shows subscription details. It fetches subscription object, 
 * checks number of users registered and number of users allowed
 * according to subscription and shows message accordingly 
 * @param el
 */
