...
var WidgetsRouter = Backbone.Router
		.extend({
			...
			routes : {
				...
				"google-apps/stripe-import" : "stripe_sync",
				"google-apps/shopify" : "shopify",
				"google-apps/salesforce" : "salesforce",
				"google-apps/zoho-import" : "zoho_sync",
				"google-apps/quickbook" : "quickbook_import"
			},
			...
			Linkedin : function(id) {
				if (!id) {
					show_set_up_widget("Linkedin", 'linkedin-login',
							'/scribe?service=linkedin&return_url='
			...
			Twilio : function(id) {
				...
				if (!id) {
					show_set_up_widget("Twilio", 'twilio-login',
							encodeURIComponent(window.location.href)
									+ "/twilio");
				}
					...
					if (!isNaN(parseInt(id))) {
						$
								.getJSON(
										"/core/api/widgets/twilio/numbers/"
												+ id,
										function(data) {
			...
			Stripe : function(id) {
				...
				if (!id) {
					show_set_up_widget("Stripe", 'stripe-login',
							'/scribe?service=stripe&return_url='
									+ encodeURIComponent(window.location.href)
									+ "/stripe");
				} else {
					{
			...
			Xero : function(id) {
				if (!id)
					show_set_up_widget(
							"Xero",
							'xero-login',
							'http://integrations.clickdesk.com:8080/ClickdeskPlugins/agile-xero-oauth?callbackUrl='
									+ encodeURIComponent(window.location.protocol
											+ "//"
											+ window.location.host
											+ "/XeroServlet?data="));
			...
			QuickBooks : function(id) {
				if (!id)
					show_set_up_widget("QuickBooks", 'quickbooks-login',
							'/OAuthServlet?service=quickbooks&return_url='
									+ encodeURIComponent(window.location.href)
									+ "/quickbooks");
				else {
					$
			...
			Facebook : function(id) {
				if (!id)
					show_set_up_widget("Facebook", 'facebook-login',
							'/scribe?service=facebook&return_url='
									+ encodeURIComponent(window.location.href)
									+ "/facebook");
				else {
					if (!isNaN(parseInt(id))) {
				...
				$('#prefs-tabs-content')
						.html(
								'<div class="row-fluid"><div class="page-header"><h2>Google <small>import Contacts from Google</small></h2></div><div class="span11"><div id="contact-prefs" class="span4" style="margin-left:0px;"></div>'
										...
										+ '<div class="row-fluid"><div class="page-header"><h2>CRM <small>import Contact from CRM</small></h2></div><div class="span11"><div id ="quickbook"></div><div id ="force"></div></div></div>'
