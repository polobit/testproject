...
var WidgetsRouter = Backbone.Router
		.extend({
			...
			StripeSync : function()
			{
				...
				this.stripe_sync_setting = new Base_Model_View({ url : 'core/api/stripe/importSetting', template : 'admin-settings-import-stripe-contact-syncPref', saveCallback:function(model){
