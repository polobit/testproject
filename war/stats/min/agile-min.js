...
function agile_setAccount(id, namespace)
{
	...
	agile_create_reference_domain_cookie();
}
...
function agile_create_reference_domain_cookie()
{
	...
	console.log("_utm_source ::" + _utm_source + "_utm_medium::" + _utm_medium + "_utm_campaign::" + _utm_campaign);

	if (_utm_source && _utm_medium && _utm_campaign)
	{
