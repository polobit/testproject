...
&lt;script type="text/javascript" &gt;
var agile = {{api_key}};
var socket = io.connect('http://stats.agilecrm.com:80');
	...
	<div class="modal-body">
		<form id='textModalForm' name="textModalForm" method="post" class="form-horizontal">
			<fieldset>
				...
				<div class="control-group">
				<label class="control-label">Label</label> <div class="controls"><input
                ...
                <div class="control-group">
				<label class="control-label">Description</label><div class="controls"> <input name="field_description"
					type="text" id="field_description" placeholder="Description" class="required"/></div></div>
			

			
                <div class="control-group">
				<label class="control-label">Searchable</label><div class="controls"> 
				<input name="searchable" type="checkbox" id="searchable" class="required"/>
				</div></div>
			
		
                <div class="control-group">
				<label class="control-label">Validation Rule</label><div class="controls"> <input name="validationRule"
...
<script id="admin-settings-custom-field-list-modal-template" type="text/html">
	...
	<div class="modal-body">
		<form id='listModalForm' name="listModalForm" method="post" class="form-horizontal">
			<fieldset>
                ...
                <div class="control-group">
				<label class="control-label">List Values</label><div class="controls"> <input name="listvalues"
...
<script id="admin-settings-custom-field-checkbox-modal-template" type="text/html">
	...
	<div class="modal-body">
		<form id='linkModalForm' name="linkModalForm" method="post" class="form-horizontal">
			<fieldset>
                ...
                <div class="control-group">
				<label class="control-label">Link Definition</label><div class="controls"> <input name="listvalues"
				...
				<ul class="nav right">
					<li class="dropdown" id="menu2">
						...
						<ul class="dropdown-menu">
							<li><a href="#textModal"  class = "fieldmodal" id="text">Text
								Field</a>
							</li>
							<li><a href="#dateModal" class = "fieldmodal"   id ="date">Date
								Field</a>
							</li>
							<li><a href="#listModal" class = "fieldmodal" id="list">List
								Field</a>
							</li>
							<li><a href="#checkboxModal"  class="fieldmodal" id="check">Check
								Box Field</a>
							</li>
