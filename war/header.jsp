						...
						<ul class="nav pull-right">
							...
							<li id="recent-menu" class="dropdown"><a
								...
								<li id="due_tasks" ><a style="position:relative;"href="#tasks"><i class="icon-tasks" title="Tasks"></i>
											<span title="Tasks due" class="block pos-abs pos-r-0 badge badge-important p-t-none p-b-none p-l-xs p-r-xs" style="top:3px" ><span  id="due_tasks_count" class="text-xxs"></span></span></a></li>
