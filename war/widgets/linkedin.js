...
$(function ()
{
	...
	var plugin_id = agile_crm_get_plugin(LINKEDIN_PLUGIN_NAME)
		.id;
	...
	function showLinkedinMatchingProfiles(plugin_id)
	{
		...
		getLinkedinMatchingProlfiles(plugin_id, function (data)
		{
			...
			{
				$('#Linkedin')
					.html(el.concat("No Matches Found"));
				return;
			}
	...
	function sendAddRequest(plugin_id, linkedin_id, subject, message)
	{
		$.get("/core/api/widgets/add/" + plugin_id + "/" + linkedin_id + "/" + subject + "/" + message, function (data)
		{
			console.log(data);
		});
	}

	function sendMessage(plugin_id, linkedin_id, subject, message)
	{
		$.get("/core/api/widgets/message/" + plugin_id + "/" + linkedin_id + "/" + subject + "/" + message, function (data)
		{
			console.log(data);
		});
	}
