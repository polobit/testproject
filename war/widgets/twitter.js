...
$(function()
{
	...
	// If not found, considering first time usage of widget, setupTwitterOAuth
	// called
	...
	$('.twitter_modify_search').die().live('click', function(e)
	{
		...
		Twitter_search_details['plugin_id'] = plugin_id;
	...
	$('.twitter_stream').die().live('click', function(e)
	{
		...
		function(data)
		{
			...
			if (data.length == 0)
			{
				...
				// On click of more if no updates available and if user have
				// initial
