    ...
    Tour = (function() {
      function Tour(options) {
        this._options = $.extend({
          ...
          template: '<div class="popover page-tour '+options.name+'"><div class="arrow"></div><div class="popover-inner"><h3 class="popover-title"></h3><div class="popover-content"><p></p></div></div></div>',
          container: 'body',
          keyboard: true,
      ...
      Tour.prototype.hideStep = function(i) {
        ...
        hideStepHelper = function(e) {
          var $element;
          console.log($(step.element, $(step.el)));
          console.log($(step.element, $(step.el)).popover("hide"));
          $element = step.el ? $(step.element, $(step.el)).popover("hide") : $(step.element).popover("hide");
          if (step.reflex) {
