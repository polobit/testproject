...
function show_modal(modal_data, modal_options, modal_callback, contact_json) {
  ...
  if (typeof MooTools == 'undefined') head.load(["lib/web-rule/lib/mootools-core-1.3.1.js", "lib/web-rule/lib//mootools-more-1.3.1.1.js"], function() {
    console.log("loading mootools dyn");
  });
  else if (window.MooTools.version < "1.3.1") head.load(["lib/web-rule/lib/mootools-core-1.3.1.js", "lib/web-rule/lib//mootools-more-1.3.1.1.js"], function() {
    console.log("loading mootools dyn");
  });

  if (modal_options.custom_html) head.load("https://d2l6lw2yloivu1.cloudfront.net/web-grabbers/lib/modal/custommodal.css", function() {
  ...
  head.load(["lib/web-rule/simple-modal.js", "css/simplemodal.css"], function() {
...
function execute_action(modal_data, modal_options, modal_callback, noty_data, noty_options, noty_callback, add_campaign_id, rm_campaign_id, add_score, rm_score, add_tags, rm_tags, custom_script, email, contact_json) {
  if (!head.load) {
...
function perform_action(anon_webrules, webrules, modal_data, modal_options, modal_callback, noty_data, noty_options, noty_callback, add_campaign_id, rm_campaign_id, add_score, rm_score, add_tags, rm_tags, custom_script) {
        ...
        _agile.get_contact(email, {
          success: function(data) {
            ...
            if ((t == 0 && len !== 0 && len == _counter) || (t !== 0 && t == counter && len == 0) || (t != 0 && t == counter && len == _counter && len !== 0)) {
              execute_action(modal_data, modal_options, modal_callback, noty_data, noty_options, noty_callback, add_campaign_id, rm_campaign_id, add_score, rm_score, add_tags, rm_tags, custom_script, email, contact_json);
            }
          },
          error: function() {
...
function webrules_execute(data) {
  ...
  for (var i = 0; i < l; i++) {
    ...
    perform_action(anon_webrules, webrules, modal_data, modal_options, modal_callback, noty_data, noty_options, noty_callback, add_campaign_id, rm_campaign_id, add_score, rm_score, add_tags, rm_tags, custom_script);
  }
}
