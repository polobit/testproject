...
<!-- Contact Details -->
	<div class="span3">
		<div class='info_wrapper' style='padding:5px;'>
...
<span class="rating">
		...
		<div style='float:right;'>
			<a href='#add-widget'>Manage widget</>
		</div>
...
<div class="well widget-add span3">
	...
	{{description}} <br/><br/>
	{{#if is_added}}
		<a class='btn btn-primary'id="delete-widget" widget-name='{{name}}'>Delete</a>
	{{else}}
...
<div class='info_wrapper'style='padding:5px;'>
	<p class="sidebar_title">
		<img src="{{mini_logo_url}}" style='width:22px;height:22px;'></img> 
		<b>{{name}}</b>
	</p>
	<span class="widget" id='{{name}}'></span>
</div>
