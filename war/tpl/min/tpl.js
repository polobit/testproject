<div class="modal hide fade" id="updateActivityModal">
...
<div class="controls">
<input type="text" name="start" placeholder="mm-dd-yyyy" id="update-event-date-1" class="required">							
</div>
</div>
<div class="control-group span2">
<label class="control-label"><b>Start Time: </b><span class="field_req">*</span></label>
<div class="controls">
<input type="text" name ="start_time" class="timepicker required" id="update-event-time-1" style="width:65px" placeholder="time">		
</div>
</div>
</div>
<div class="row">
...
<div class="controls">
<input type="text" name="end" placeholder="mm-dd-yyyy" id="update-event-date-2" class="required">									
</div>
</div>
<div class="control-group span2">
<label class="control-label"><b>End Time: </b><span class="field_req">*</span></label>
<div class="controls">							
<input type="text" name ="end_time" class="timepicker required" id="update-event-time-2" style="width:65px" placeholder="time"><br />		
</div>
</div>			 						
</div>
...
<a href="#" class="btn" id="event_delete">Delete</a>
</div>
</div>
</div>
...
<a href="#" class="btn right" id="delete_campaign_logs" style='top:-25px;position:relative;padding-right:20px'>Delete All Logs</a>
</div>
</div>
</div>
...
<input name="id" type="hidden" value="{{campaign_id}}" />
...
<h1>Dashboard</h1>
</script><script id="help-email-form-template" type="text/html">
<div class="span8">
<div class="well">
<form id='helpemailForm' name="helpemailForm" class="form-horizontal">
<fieldset>
<legend>Mail For Help</legend>
<div class="control-group">
<label class="control-label">From</label>
<div class="controls">
<input type="text" class="span4" id="from" name="from" />
...
<label class="control-label">To</label>
<div class="controls ">
<select name="to"><option value="sukanya@invox.com">Admin</option><option value="sukanya@invox.com">Support</option><option value="praveen@invox.com">Sales</option></select>
</div>
</div>
<div class="control-group">
<label class="control-label">Subject</label>
...
<div class="form-actions">          
<a href="#contact" class="btn ">Close</a> 
<a href="#"  id="helpEmail" class="btn btn-primary">Send</a>
</div>
</fieldset>
</form>
</div>
...
<option value="green" selected="selected">Normal</option>
...
<label class="control-label"><b>Start Date: </b><span class="field_req">*</span></label>
<div class="controls">
<input type="text" name="start" placeholder="mm-dd-yyyy" id="event-date-1" class="required">							
</div>
</div>
<div class="control-group span2">
<label class="control-label"><b>Start Time: </b><span class="field_req">*</span></label>
<div class="controls">
<input type="text" name ="start_time" class="timepicker required" id="event-time-1" style="width:65px" placeholder="time">		
</div>
</div>
</div>
<div class="row">
...
<label class="control-label"><b>End Date: </b><span class="field_req">*</span></label>
<div class="controls">
<input type="text" name="end" placeholder="mm-dd-yyyy" id="event-date-2" class="required">									
</div>
</div>
<div class="control-group span2">
<label class="control-label"><b>End Time: </b><span class="field_req">*</span></label>
<div class="controls">							
<input type="text" name ="end_time" class="timepicker required" id="event-time-2" style="width:65px" placeholder="time"><br />		
</div>
</div>			 						
</div>
<div class="control-group">                    	
...
<input type="text" id = "task_related_to" class="typeahead typeahead_contacts" data-provide="typeahead" data-mode="multiple" size="40"/>
</div>
</div>
</div>
</fieldset>				
...
<input type="text" id = "note_related_to" class="typeahead typeahead_contacts" data-provide="typeahead" data-mode="multiple" size="40"/>
</div>
</div>
</div>					
</fieldset>
...
<label class="control-label" style="margin-left:20px;"><b>Name:</b> <span class="field_req">*</span></label>
