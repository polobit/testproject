<div class="modal hide" id="updateActivityModal"> <div class="modal-header"> <button class="close" data-dismiss="modal">x</button> <h3>Update Activity</h3> </div> <div class="modal-body"> <div id="newrelatedEvent"> <span class="alert alert-info" style="font-size:11px">Events are time based such as meetings. They show up in calendar.</span> <br/> <br/> <form id='updateActivityForm' name="newactivityForm" method="post"> <div class="row"> <div id="updateEvent" class="span6"> <label for="title"> Event<span>*</span> </label> <span class="input "><input id="title" type="text" name="title" size="40" class="required"> </span> </div> </div> <input type="text" name="start" class="span2" placeholder="start date(mm-dd-yyyy)" id="update-event-date-1"> <input type="text" name="start_time" class="timepicker" id="update-event-time-1" style="width:65px" placeholder="start time">&nbsp;to&nbsp; <input type="text" name="end" class="span2" placeholder="end date(mm-dd-yyyy)" id="update-event-date-2"> <input type="text" name="end_time" class="timepicker" id="update-event-time-2" style="width:65px" placeholder="end time"><br/> <input type="checkbox" name="alldayevent" id="alldayevent">&nbsp; <span style="vertical-align:bottom">All day event</span> </form> </div> <div class="modal-footer"> <a href="#" class="btn btn-primary" id="task_event_validate">Update</a>&nbsp; <a href="#" class="btn btn-danger" id="event_delete">Delete</a> </div> </div> </div> <script id="calendar-template" type="text/html">
...
</script> <script id="campaign-logs-model-template" type="text/html">
...
</script> <script id="campaigns-model-template" type="text/html">
...
</script> <script id="deals-model-template" type="text/html">
...
</script> <script id="email-social-model-template" type="text/html">
	<td> {{date}} </td>
	<td> {{from}} </td>
	<td> {{to}} </td>
	<td> {{subject}} </td>
...
</script> <script id="events-modal-template" type="text/html">
...
</script> <script id="notes-modal-template" type="text/html">
	<td><icon class='deleteNote icon-remove-circle'></icon></td>  	
  	<td>{{id}} </td>
  	<td>{{subject}} </td>
   	<td>{{note}}</td>
...
</script> <script id="stats-model-template" type="text/html">
	<td> {{u}} </td>
	<td> {{i}} </td>
...
<div class="span12">
 <div class="page-header">
	...
	<div class="btn-group right" style='top:-50px;position:relative;padding-right:20px'>

<div id='star' style='padding-bottom:10px'></div>
...
<a class="btn" href="#"><i class="icon-print"></i></a>
				<button class="btn">Actions</button>
  				...
  				<ul class="dropdown-menu">
					...
					<li><a href='#' id="contact-add-task">Add Task</a></li>   	
					<li><a href='#add-opportunity'>Add Opportunity</a></li>   				
...
<!-- Contact Details -->
	<div class="span3">
		<div class='info_wrapper'>
			...
			<div class="">
				<p class="sidebar_title"><i class="icon-user "></i> Contact details</p>
			</div>
...
<span class="rating">
			...
			<div>	
				...
				<li><span><a href='#tags/{{this}}'>{{this}}</a></span>
</li>
  					{{/each}}
...
</script> <script id="contact-view-model-template" type="text/html">
<a id='{{id}}' class="ContactView" href="#">{{name}}</a>
</script> <script id="contacts-custom-view-image-template" type="text/html">
...
</script> <script id="contacts-custom-view-first_name-template" type="text/html">
	<td class='data' data='{{id}}'>
		<b>
		{{getPropertyValue properties "last_name"}}
		</b>
	</td>
</script> <script id="contacts-custom-view-last_name-template" type="text/html">
	<td class='data' data='{{id}}'>
		<b>
			{{getPropertyValue properties "last_name"}}
		</b>
	</td>
</script> <script id="contacts-custom-view-email-template" type="text/html">
	<td class='data' data='{{id}}'>
		{{getPropertyValue properties "email"}}
	</td>
</script> <script id="contacts-custom-view-company-template" type="text/html">
	<td class='data' data='{{id}}'>
		{{getPropertyValue properties "title"}}<br/>
		{{getPropertyValue properties "company"}}
	</td>
</script> <script id="contacts-custom-view-tags-template" type="text/html">
  	<td class='data' data='{{id}}'> 
		{{#each tags}}
			<b>
...
</script> <script id="contacts-custom-view-created_time-template" type="text/html">
	<td class='data' data='{{id}}'>
		{{epochToHumanDate "mm-dd-yy" created_time}}
	</td>
</script> <script id="contacts-custom-view-updated_time-template" type="text/html">
	<td class='data' data='{{id}}'>
		{{epochToHumanDate "mm-dd-yy" updated_time}}
	</td>
</script> <script id="contacts-custom-view-title-template" type="text/html">
	<td class='data' data='{{id}}'>
			...
			<form id="opportunityform" class="form-horizontal">
		  		<fieldset>
					...
					<div class="form-actions">          
						...
						<a href="#contact-views" class="btn ">Cancel</a>
					</div>
				</fieldset>
			</form>
...
</script> <script id="contact-custom-view-model-template" type="text/html">
...
</script> <script id="contacts-custom-view-model-template" type="text/html">
...
-->
</script> <script id="contacts-custom-view-collection-template" type="text/html">
...
<option value="ANYOF" class="tag">is any of</option>	  
								...
								<td>
								  ...
								  <select id="thirdSelect" name="">
									...
									<option value="AX" class="COUNTRYEQUALS COUNTRYNOTEQUALS">�land Islands </option>
									...
									<option value="CI" class="COUNTRYEQUALS COUNTRYNOTEQUALS">C�te d'Ivoire</option>
									...
									<option value="CW" class="COUNTRYEQUALS COUNTRYNOTEQUALS">Cura�ao</option>
									...
									<option value="RE" class="COUNTRYEQUALS COUNTRYNOTEQUALS">R�union</option>
									...
									<option value="BL" class="COUNTRYEQUALS COUNTRYNOTEQUALS">Saint Barth�lemy</option>
...
{{getPropertyValue properties "company"}}</td>
  ...
  {{/each}}</td>
	<td> Lead Score</td>
</script> <script id="contacts-collection-template" type="text/html">
...
<div class="well" id='tasks'>
<div id='pie-tags-chart' style='width:100%; height:300px'></div>
...
<div class="slate">
    <div class="slate-content">
      ...
      <div class="box-right">
        <h3>Your project doesn't have any tasks yet.</h3>
        <div class="text">
          Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer posuere erat a ante venenatis. Nullam quis risus eget urna mollis ornare vel eu leo.
        </div>
        <a href="#">Learn more about project tasks</a>
        <br>
        <span class="btn blue btn-slate-action"><i class="icon-plus-sign"></i> Add the first task!</span>
      </div>
    </div>
  </div>
...
</script> <script id="import-contacts-2-template" type="text/html">
...
</script> <div class="modal hide" id="activityModal"> <div class="modal-header"> <button class="close" data-dismiss="modal">x</button> <h3>Add New Activity</h3> </div> <div class="modal-body"> <a href="#" id="event" style="border-right: 1px solid #BFBFBF; padding-right: 8px; color:black;"> Event (Calendar)</a> <a href="#" id="task" style="padding-left: 8px;">Task (To-do)</a> <input type="hidden" value="event" id="hiddentask"/><br/> <br/> <div id="relatedEvent"> <p><i><i class="icon-calendar"></i> Events are time based such as meetings. They show up in calendar.</i></p><br/> <form id='activityForm' name="activityForm" method="post"> <fieldset> <div id="addEvent" class="control-group"> <label class="control-label"><b>Event Name: </b><span class="field_req">*</span></label> <div class="controls"> <input id="title" placeholder='Name of the event' type="text" name="title" class="required"> </div> </div> <div class="row"> <div class="control-group span3"> <label class="control-label"><b>Start Date: </b><span class="field_req">*</span></label> <div class="controls"> <input type="text" name="start" placeholder="mm-dd-yyyy" id="event-date-1" class="required"> </div> </div> <div class="control-group span2"> <label class="control-label"><b>Start Time: </b><span class="field_req">*</span></label> <div class="controls"> <input type="text" name="start_time" class="timepicker required" id="event-time-1" style="width:65px" placeholder="time"> </div> </div> </div> <div class="row"> <div class="control-group span3"> <label class="control-label"><b>End Date: </b><span class="field_req">*</span></label> <div class="controls"> <input type="text" name="end" placeholder="mm-dd-yyyy" id="event-date-2" class="required"> </div> </div> <div class="control-group span2"> <label class="control-label"><b>End Time: </b><span class="field_req">*</span></label> <div class="controls"> <input type="text" name="end_time" class="timepicker required" id="event-time-2" style="width:65px" placeholder="time"><br/> </div> </div> </div> <div class="control-group"> <div class="controls"> <label class="checkbox"> <input type="checkbox" name="alldayevent" id="alldayevent"> <span style="vertical-align:bottom; display:inline;">All day event</span></label> </div> </div> </fieldset> </form> </div> <div id="relatedtask" style="display:none"> <div> <p><i><i class="icon-tasks"></i> Tasks are like to-dos. Result oriented. You can assign a category such as call, <br/>email etc</i></p><br/> </div> <form id='taskForm' name="taskForm" method="post"> <fieldset> <div class="row"> <div id="addTask" class="span3 control-group"> <label for="subject" class="control-label"> <b>Task:</b> <span class="field_req">*</span></label> <div class="controls"><span class="input "><input id="subject" type="text" name="subject" size="40" class="required"> </span> </div> </div> <div id="taskCategory" class="span2 control-group"> <label for="type" class="control-label"><b> Category: </b><span class="field_req">*</span></label> <div class="controls"> <span class="input"> <select name="type" id="type" size="1" class="input-small required"> <option></option> <option value="CALL">Call</option> <option value="EMAIL">Email</option> <option value="FOLLOW_UP">Follow-up</option> <option value="MEETING">Meeting</option> <option value="MILESTONE">Milestone</option> <option value="SEND">Send</option> <option value="TWEET">Tweet</option> </select> </span> </div> </div> </div> <div class="row"> <div class="span3 control-group"> <label for="due" class="control-label"><b>Date (Due): </b><span class="field_req">*</span></label> <div class="controls"> <input type="text" name="due" placeholder="mm-dd-yyyy" id="task-date-1" class="required"> </div> </div> <div class="span2 control-group"> <label for="priority_type" class="control-label"><b>Priority: </b><span class="field_req">*</span></label> <div class="controls"> <span class="input "> <select name="priority_type" id="priority_type" size="1" class="input-small required"> <option></option> <option value="DEFAULT">Default</option> <option value="HIGH">High</option> <option value="MEDIMUM">Medium</option> <option value="LOW">Low</option> </select> </span> </div> </div> </div> <div class="control-group"> <label class="control-label"><b>Related To:</b></label> <div class="controls"> <div> <div class="pull-left" style="margin-left:-14px"> <ul name="contacts" class="tags"></ul> </div> <input type="text" id="task_related_to" class="typeahead typeahead_contacts" data-provide="typeahead" data-mode="multiple" size="40"/> </div> </div> </div> </fieldset> </form> </div> </div> <div class="modal-footer"> <a href="#" class="btn btn-primary" id="task_event_validate">Save changes</a> </div> </div> <div class="modal hide" id="companyModal"> <div class="modal-header"> <button class="close" data-dismiss="modal">x</button> <h3>Add Company</h3> </div> <div class="modal-body"> <form id='companyForm' name="companyForm" method="post"> <fieldset> <p> <div class="control-group"> <label class="control-label"><b>Company:</b> <span class="field_req">*</span></label> <div class="controls"> <input name="cmpany" type="text" class="required" id="cmpany" placeholder="Company" style="width:150px;"/> </div> </div> <div class="control-group"> <label class="control-label"><b>URL:</b> <span class="field_req">*</span></label> <div class="controls"> <div class="input-prepend""> <span class="add-on">http://</span><input class="input-large required" name="url" type="text" id="url" placeholder="www."/> </div> </div> </div> </fieldset> </form> </div> <div class="modal-footer"> <a href="#continue-company" class="btn" id="continue-company">Continue Editing</a> <a href="#" class="btn btn-primary" id="company_validate">Save changes</a> </div> </div> <div class="modal hide fade note-modal" id="noteModal"> <div class="modal-header"> <button class="close" data-dismiss="modal">x</button> <h3>Add Note</h3> </div> <div class="modal-body"> <form id='noteForm' name="noteForm" method="post"> <fieldset> <input name="contact_id" type="hidden" value=""/> <div class="control-group"> <label class="control-label"><b>Note:</b></label> <div class="controls"> <input type="text" name="note" id="note"/> </div> </div> <div class="control-group"> <label class="control-label"><b>Subject:</b></label> <div class="controls"> <input type="text" name="subject" id="subject"/> </div> </div> <div class="control-group"> <label class="control-label"><b>Related To:</b></label> <div class="controls"> <div> <div class="pull-left" style="margin-left:-14px"> <ul name="contacts" class="tags"></ul> </div> <input type="text" id="note_related_to" class="typeahead typeahead_contacts" data-provide="typeahead" data-mode="multiple" size="40"/> </div> </div> </div> </fieldset> </form> </div> <div class="modal-footer"> <a href="#" class="btn btn-primary" id="note_validate">Save changes</a> </div> </div> <div class="modal hide" id="personModal"> <div class="modal-header"> <button class="close" data-dismiss="modal">x</button> <h3>Add Person</h3> </div> <div class="modal-body"> <form id='personForm' name="personForm" method="post"> <fieldset> <div class="control-group"> <label class="control-label"><b>Name:</b> <span class="field_req">*</span></label> <div class="controls"> <input name="first_name" type="text" class="required" id="fname" placeholder="First name"/> <input name="last_name" class="required" type="text" id="lname" placeholder="Last name"/> </div> </div> <div class="control-group"> <label class="control-label"><b>Company:</b></label> <div class="controls"> <input name="company" type="text" id="company" placeholder="Company"/> </div> </div> <div class="control-group"> <label class="control-label"><b>Job Description:</b></label> <div class="controls"> <input name="title" type="text" id="title" placeholder="Job title"/> </div> </div> <div class="row"> <div class="span5 duplicate-email"> </div> </div> <div class="control-group"> <label class="control-label"><b>Email:</b> </label> <div class="controls"> <input name="email" type="text" id="email" placeholder="Email"/> </div> </div> <div class="control-group"> <label class="control-label"><b>Tags:</b> </label> <div class="controls"> <input name="tags" type="text" id="tags-new-person" class="tags-typeahead"/> </div> </div> <div class="control-group"> <div class="controls"> <span style="display:inline;"><i class='icon-arrow-right'></i></span><a href="#import" data-dismiss="modal" id="import-link"> Click here to import multiple contacts from a file</a> </div> </div> </fieldset> </form> </div> <div class="modal-footer"> <a href="#continue-contact" class="btn" id='continue-contact'>Continue Editing</a> <a href="#" class="save btn btn-primary" id="person_validate">Save changes</a> </div> </div> <script id="notes-collection-template" type="text/html">
 <h2>List of Notes</h2>
...
</script> <script id="opportunities-model-template" type="text/html">
<td leads='{{id}}' class='leads'>
	<div style='display:inline;padding-right:10px;height:auto;'>
		<img src="{{gravatarurl properties 40}}" width='40px' height='40px'>
	</div>
...
</script> <script id="owners-collection-template" type="text/html">
 	<div class="control-group">
...
</script> <Script id="owners-model-template" type="text/html">
	{{name}}
...
</script> <script id="search-collection-template" type="text/html">
...
</script> <script id="tasks-model-template" type="text/html">
...
</script> <script id="widgets-add-model-template" type="text/html">
...
</script> <script id="widgets-add-collection-template" type="text/html">
<div class="row">
	<div class = "span12">
		<div class = "page-header">
			<h2>Add Widgets</h2>
...
<div class='info_wrapper'>
	<span class="widget" id='{{name}}'></span>sdsd
</div>

</script> <script id="widgets-collection-template" type="text/html">
...
</script> <script id="workflows-collection-template" type="text/html">
