...
public class AgileCRMServlet extends HttpServlet
{
	public void doGet(HttpServletRequest req, HttpServletResponse resp) throws IOException
	{
		...
		Contact contact = new Contact(Contact.Type.PERSON, "", "Chirag", "Patel", tags, properties);
		contact.save();
		*/
		...
		Event e = new Event("Test 1", start.getTimeInMillis()/1000, end.getTimeInMillis()/1000, false, null, null);
		e.save();
		
		start.add(Calendar.DATE, 1);
		end.add(Calendar.DATE, 1);
		
		e = new Event("Test 1", start.getTimeInMillis()/1000, end.getTimeInMillis()/1000, false, null, null);
		e.save();*/
		
		Calendar end = Calendar.getInstance();
		end.add(Calendar.HOUR, 1);
		Task task = new Task(Task.Type.CALL, end.getTimeInMillis()/1000, 0L, 0L);
		task.save();
		...
		//EmailTemplates emailTemplate = new EmailTemplates("test subject", "test uasdfasdf");
		//emailTemplate.save();
