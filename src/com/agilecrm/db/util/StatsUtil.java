...
public class StatsUtil
{
    ...
    public static void addToCampaignLogs(String domain, String campaignId,
	    String subscriberId, long logTime, String message, String type)
    {
    ...
    {
	String emailLogs = "SELECT * FROM campaign_logs WHERE campaign_id = "
		+ campaignId + " AND domain = " + encodeSQLColumnValue(domain);

	JSONArray arr = new JSONArray();

	try
	{
	    arr = GoogleSQL.getJSONQuery(emailLogs);

	    if (arr == null)
		return null;

	    System.out.println("Email Logs of given campaign: " + arr);
	}
	catch (Exception e)
	{
	    e.printStackTrace();
