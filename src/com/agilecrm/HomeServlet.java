...
public class HomeServlet extends HttpServlet
{
	public void doGet(HttpServletRequest req, HttpServletResponse resp) throws IOException
	{
		...
		try
		{
			...
			{
				req.getRequestDispatcher("/error/user-disabled.jsp").include(req, resp);  
				return;
			}
	...
	public void register(User user, HttpServletRequest req, HttpServletResponse resp) throws Exception
	{
		...
		if (email != null)
		{
			DomainUser newUser = DomainUser.getDomainUserFromEmail(email, domain);
			if(newUser != null)
			{
		...
		// Check if this user has any other registrations before  in other domains
		DomainUser domainUser = DomainUser.getDomainUserFromEmail(email);
		if (domainUser != null)
		{
			req.getRequestDispatcher("/error/wrong-user.jsp").include(req, resp);  
			return;
		}
