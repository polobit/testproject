 ...
 *******************************************************************************/
package com.agilecrm.samples.apps.marketplace.openid;

import com.google.appengine.api.urlfetch.URLFetchService;
import com.google.appengine.api.urlfetch.URLFetchServiceFactory;
import com.agilecrm.samples.apps.marketplace.openid.appengine.AppEngineHttpFetcher;
import com.agilecrm.samples.apps.marketplace.openid.appengine.AppEngineTrustsRootProvider;
import com.agilecrm.samples.apps.marketplace.openid.appengine.Openid4javaFetcher;
...
public class GuiceModule extends AbstractModule
{
    ...
    /**
     * Overrides for running on GAE. Need to ue special HTTP fetchers &
     * explicitly set the trust roots since the built-in java equivalents are
     * not available when running in GAE's sandbox.
     */
