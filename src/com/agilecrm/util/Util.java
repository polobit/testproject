...
public class Util
{
	...
	public static String appendTrackingImage(String html, String campaignId, String subscriberId)
	{
		...
		String trackingImage = "<div class=\"ag-img\"><img src=\"https://" + namespace
				+ ".agilecrm.com/backend/open?n=" + namespace + "&c=" + campaignId + "&s=" + subscriberId
	...
	{
		emailBody = emailBody.replace("&amp;", "&").replace("&lt;", "<").replace("&gt;", ">").replace("&quot;", "\"")
				.replace("&nbsp;", "");
