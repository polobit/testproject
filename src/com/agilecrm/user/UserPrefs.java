...
public class UserPrefs
{
	...
	UserPrefs(Long userId, String name, String template, String signature, boolean task_reminder)
	{
		this.name = name;
	...
	{
		UserPrefs userPrefs = new UserPrefs(agileUser.id, null, "default", "- Powered by AgileCRM", true);
		userPrefs.save();
		return userPrefs;
	}
