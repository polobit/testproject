...
public class DomainUser
{
	...
	public static DomainUser getDomainUserFromEmail(String email, String domain)
	{
		...
		{
			Objectify ofy = ObjectifyService.begin();
			return ofy.query(DomainUser.class).filter("email", email).filter("domain", domain).get();
		}
		finally
		{
			NamespaceManager.set(oldNamespace);
	...
	public static DomainUser getDomainCurrentUser()
	{
		...
		{
			Objectify ofy = ObjectifyService.begin();
			return ofy.query(DomainUser.class).filter("user", user).filter("domain", domain).get();
		}
		finally
		{
			NamespaceManager.set(oldNamespace);
