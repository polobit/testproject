...
public class API
{
	...
	public String timlineContacts() throws JSONException
	{
		...
		for (Contact contact : contacts)
		{
			...
			object2.put("headline",
					contact.getContactFieldValue("first_name") + " " + contact.getContactFieldValue("last_name"));
	...
	public String timlineTasks() throws JSONException
	{
		...
		QueryResultIterator<Task> taskIterator = ofy.query(Task.class).filter("created_time < ", new Date().getTime())
				.limit(10).fetch().iterator();
