...
public class JSAPI
{
	...
	public String createTask(@QueryParam("email") String email, @QueryParam("task") String json,
			@QueryParam("callback") String jsoncallback, @QueryParam("id") String key)
	{
		try
		{
			ObjectMapper mapper = new ObjectMapper();
	...
	@GET
	@Produces("application/x-javascript")
	public String createNote(@QueryParam("email") String email, @QueryParam("note") String json,
			@QueryParam("callback") String jsoncallback)
	{
		try
		{
	...
	public String createOpportunity(@QueryParam("email") String email, @QueryParam("id") String apiKey,
			@QueryParam("opportunity") String json, @QueryParam("callback") String jsoncallback)
	{
		try
		{
			ObjectMapper mapper = new ObjectMapper();
	...
	@GET
	@Produces("application/x-javascript")
	public Boolean addScore(@QueryParam("email") String email, @QueryParam("score") Integer score,
			@QueryParam("callback") String jsoncallback)
	{
		Contact contact = ContactUtil.searchContactByEmail(email);
		if (contact == null)
