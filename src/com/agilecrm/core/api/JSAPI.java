...
public class JSAPI
{
    ...
    public String getContact(@QueryParam("email") String email, @QueryParam("callback") String jsoncallback)
    {
	try
	{
    ...
    @GET
    @Produces("application/x-javascript")
    public String createContact(@QueryParam("contact") String json, @QueryParam("id") String apiKey, @QueryParam("callback") String jsoncallback)
    {
	try
	{
	    ObjectMapper mapper = new ObjectMapper();
    ...
    @GET
    @Produces("application/x-javascript")
    public String createTask(@QueryParam("email") String email, @QueryParam("task") String json, @QueryParam("callback") String jsoncallback,
    ...
    @GET
    @Produces("application/x-javascript")
    public String createOpportunity(@QueryParam("email") String email, @QueryParam("id") String apiKey, @QueryParam("opportunity") String json,
    ...
    public String addTags(@QueryParam("email") String email, @QueryParam("tags") String tags, @QueryParam("callback") String jsoncallback)
    {
	try
	{
    ...
    @GET
    @Produces("application/x-javascript")
    public String addScore(@QueryParam("email") String email, @QueryParam("score") Integer score, @QueryParam("callback") String jsoncallback)
    {
	try
	{
	    Contact contact = ContactUtil.searchContactByEmail(email);
    ...
    @GET
    @Produces("application / x-javascript")
    public String addProperty(@QueryParam("data") String json, @QueryParam("email") String email, @QueryParam("callback") String jsoncallback)
    {
	try
	{
	    Contact contact = ContactUtil.searchContactByEmail(email);
