...
public class ContactEmailUtil
{
	...
	public static void saveContactEmailAndSend(String fromEmail, String fromName, String to, String cc, String bcc,
			String subject, String body, Contact contact)
	{
		try
		{
	...
	public static void saveContactEmail(String fromEmail, String fromName, String to, String cc, String bcc,
			String subject, String body, Long contactId, int toEmailSize)
	{
	...
	public static String getIMAPURLForPrefs(IMAPEmailPrefs imapPrefs, String searchEmail, String offset, String count)
	{
		...
		String url = "https://agile-imap.appspot.com/imap?user_name=" + URLEncoder.encode(userName) + "&search_email="
				+ searchEmail + "&host=" + URLEncoder.encode(host) + "&port=" + URLEncoder.encode(port) + "&offset="
				+ offset + "&count=" + count + "&command=imap_email&password=" + URLEncoder.encode(password);
	...
	public static int sendBulkContactEmails(JSONObject emailData, List<Contact> contactList)
	{
		...
		try
		{
			...
			for (Contact contact : contactList)
			{
				...
				saveContactEmailAndSend(fromEmail, fromName, contact.getContactFieldValue(Contact.EMAIL), null, null,
