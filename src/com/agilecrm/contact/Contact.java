...
public class Contact
{
	...
	public String toString()
	{
		return "id: " + id + " created_time: " + created_time + " updated_time" + updated_time + " type: " + type
				+ " creator:" + creator + " tags: " + tags + " properties: " + properties;
	}
	...
	public static ContactCursorResult getAllContactsByCount(int max, String cursor)
	{
		Objectify ofy = ObjectifyService.begin();
	...
	public static Contact searchContactByEmail(String email)
	{
		...
		Objectify ofy = ObjectifyService.begin();
		return ofy.query(Contact.class).filter("properties.name = ", EMAIL).filter("properties.value = ", email).get();
	}
	...
	public static int searchContactCountByEmail(String email)
	{
		// Look in the property Class
		Objectify ofy = ObjectifyService.begin();
		return ofy.query(Contact.class).filter("properties.name = ", EMAIL).filter("properties.value = ", email)
				.count();
	}
