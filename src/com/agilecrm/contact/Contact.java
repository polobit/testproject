...
public class Contact extends Cursor {
	 ...
	 * List<Key<Contact>> contactKeys = new ArrayList<Key<Contact>>(); for
	 * (String contact_id : id_array) { contactKeys.add(new
	 * Key<Contact>(Contact.class, Long .parseLong(contact_id))); }
	 * dao.deleteKeys(contactKeys); }
	 */
