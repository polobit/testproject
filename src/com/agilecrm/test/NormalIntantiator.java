...
public class NormalIntantiator extends HttpServlet
{
	...
	String url = BackendServiceFactory.getBackendService().getBackendAddress(backends);
    ...
    {
	System.out.println("Posted to backends : " + BackendServiceFactory.getBackendService().getCurrentBackend() + ": instance in" + BackendServiceFactory.getBackendService().getCurrentInstance());;
    }
