...
public class WebCalendarEvent
{
    ...
    {
	return "WebCalendarEvent [id=" + id + ", name=" + name + ", slot_time=" + slot_time + ", userName=" + userName
		+ ", email=" + email + ", date=" + date + ", notes=" + notes + ", phoneNumber=" + phoneNumber
		+ ", selectedSlots=" + selectedSlots + ", selectedSlotsString=" + selectedSlotsString
