...
public class SearchRule implements Serializable
{
	...
	{
		EQUALS, ON, AFTER, BEFORE, BETWEEN, LAST, NEXT, NOTEQUALS, MATCHES, IS_GREATER_THAN, IS_LESS_THAN, FIRST_TIME, REPEAT, NOT_CONTAINS, ONCE_PER_SESSION, ONLY_ONCE, EVERYTIME
	}
