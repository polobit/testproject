...
/**
 * <code>SMSDeferredTask</code> is the deferred task that handles send
 * SMS details of every task
 * 
 * @author  Bhasuri
 * 
 */
...
public class SMSDeferredTask implements DeferredTask
{
	 ...
	 * @param metadata
     */
    public SMSDeferredTask(String smsGatewayType, String domain,  String version, String fromNumber, String toNumber, String body,
    		String account_sid, String auth_token, String smsEndpoint, String metadata)
    {
	...
	System.out.println("SMSDeferredTask run...");
		...
		try
		{
			TwilioSMS.sendSMS(account_sid, auth_token, smsEndpoint, version, fromNumber, toNumber, body, metadata);
		}
