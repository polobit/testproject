...
public class NamespaceFilter implements Filter
{
	...
	private boolean setNamespace(ServletRequest request, ServletResponse response)
	{
		...
		// Redirect to choose domain page if not localhost - on localhost - we do it on empty namespace
