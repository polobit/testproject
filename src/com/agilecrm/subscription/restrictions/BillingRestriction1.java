 ...
 * 
 */
public class BillingRestriction1
{
    @Id
    public Long id;
    ...
    private static ObjectifyGenericDao<BillingRestriction1> dao = new ObjectifyGenericDao<BillingRestriction1>(BillingRestriction1.class);
    ...
    private BillingRestriction1(PlanLimitsEnum limits)
    {
     ...
     * @return
     */
    public static BillingRestriction1 getInstance(String planName, Integer users)
    {
	return new BillingRestriction1(BillingRestrictionUtil.getPlan(planName, users).getPlanLimits());
    }
    ...
    {
	BillingRestriction1 restriction = (BillingRestriction1) object;
