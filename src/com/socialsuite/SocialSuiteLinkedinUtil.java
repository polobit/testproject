...
public class SocialSuiteLinkedinUtil
{
	 ...
	 * LinkedIn based on token and token secret provided when user creates a
	 * connect
	 * 
	 * @param token
	 *            {@link String}
			...
			throws SocketTimeoutException, IOException, Exception
	{
		...
		// void postShare(String commentText,String title,String
		// description,String url,String imageUrl,VisibilityType
		// visibility,boolean postToTwitter)
		client.postShare(commentText, null, "www.agilecrm.com", null, visibility, postToTwitter);
		return "Message sent successfully";
	}

	public static List<SocialUpdateStream> getLinkedInUpdate(Stream stream) throws SocketTimeoutException, IOException,
			Exception
	{
	...
	public static List<SocialUpdateStream> getLinkedInRecentUpdate(Stream stream) throws SocketTimeoutException,
		...
		for (Update update : network.getUpdates().getUpdateList())
		{
			...
			if (update.getUpdateContent().getPerson().getCurrentShare() != null)
			{
				...
				json = new JSONObject().put("comment",
						...
						Util.toJSONString(update.getUpdateContent().getPerson().getCurrentShare()));
