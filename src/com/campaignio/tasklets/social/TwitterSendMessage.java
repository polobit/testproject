...
public class TwitterSendMessage extends TaskletAdapter
{
			...
			throws Exception
	{
		...
		log(campaignJSON, subscriberJSON, "Adding tweet for this user: " + message);

		TwitterQueue.addToTwitterQueue(account, token, tokenSecret, message, rateLimit, subscriberJSON, campaignJSON);
