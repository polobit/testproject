...
public class Log
{
    ...
    public enum LogType
    {
	EMAIL_SENT, EMAIL_OPENED, EMAIL_CLICKED, WAIT, CLICKED, AB, URL_VISITED, TWEET, ADD_NOTE, TAGS, CHECK_TAGS, CONDITION, JSONIO, SCORE, SET_OWNER, ADD_TASK, ADD_DEAL, TRANSFER, GENDER, EMAIL_SLEEP, EMAIL_SENDING_FAILED
    };
