...
public class ShopifyServiceBuilder
{
       ...
       */
      public ShopifyServiceBuilder provider(Class<? extends com.thirdparty.shopify.Api> apiClass)
      {
        this.api = createApi(apiClass);
        return this;
      }

      private Api createApi(Class<? extends com.thirdparty.shopify.Api> apiClass)
      {
