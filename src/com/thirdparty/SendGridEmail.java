...
public class SendGridEmail
{
	...
	public static String defaultQueryString = SENDGRID_API_PARAM_API_USER + "=" + SENDGRID_API_USER_NAME + "&"
			+ SENDGRID_API_PARAM_API_KEY + "=" + SENDGRID_API_KEY + "&";

	public static String sendMail(String fromEmail, String fromName, String to, String subject, String replyTo,
			String html, String text, JSONObject subscriberJSON, JSONObject campaignJSON)
	{
		try
		{
			// Query string
			...
			queryString = defaultQueryString + SENDGRID_API_PARAM_TO + "=" + URLEncoder.encode(to) + "&"
					+ SENDGRID_API_PARAM_SUBJECT + "=" + URLEncoder.encode(subject) + "&" + SENDGRID_API_PARAM_FROM
					+ "=" + URLEncoder.encode(fromEmail) + "&" + SENDGRID_API_PARAM_FROM_NAME + "="
			...
			// Send email
			String response = Util.accessURLUsingPost(SENDGRID_API_POST_URL, queryString);
