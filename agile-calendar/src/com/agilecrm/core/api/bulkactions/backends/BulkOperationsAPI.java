...
public class BulkOperationsAPI
{
	...
	try
	{
	    Mailgun.sendMail("campaigns@agile.com", "Campaign Observer", "naresh@agilecrm.com", null, null,
		    ...
		    "Hi Naresh,<br><br> Campaign Initiated:<br><br> User id: " + current_user_id
		            + "<br><br>Campaign-id: " + workflowId + "<br><br>Filter-id: " + filter + "<br><br>Fetched Count: "
		            + count + "<br><br>Filter count: "+ fetcher.getAvailableContacts(), null);
	}
	catch (Exception e)
	{
	    e.printStackTrace();
	...
	ActivitySave.createBulkActionActivity(count, "ASIGN_WORKFLOW", workflowname,
	        "contacts", "");
