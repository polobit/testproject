 ...
 */
public interface OAuthCustomService
{
    /**
    ...
    /**
     * return custom url user can replace or customize authorize url with passed
     * param
     * 
     * @param para
     * @return
    ...
    public String getAuthorizationUrl(String para);
}
